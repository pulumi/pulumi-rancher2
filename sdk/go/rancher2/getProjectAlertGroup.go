...
func (o LookupProjectAlertGroupResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupProjectAlertGroupResult] {
	return pulumix.Output[LookupProjectAlertGroupResult]{
