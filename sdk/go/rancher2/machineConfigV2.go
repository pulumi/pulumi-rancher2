...
//			foo_harvester, err := rancher2.GetClusterV2(ctx, &rancher2.LookupClusterV2Args{
//				Name: "foo-harvester",
//			}, nil)
//			if err != nil {
//				return err
...
type MachineConfigV2 struct {
	...
	GoogleConfig MachineConfigV2GoogleConfigPtrOutput `pulumi:"googleConfig"`
	...
	NutanixConfig MachineConfigV2NutanixConfigPtrOutput `pulumi:"nutanixConfig"`
...
type machineConfigV2State struct {
	...
	// Google config for the Machine Config V2. Conflicts with `amazonec2Config`, `azureConfig`, `digitaloceanConfig`, `harvesterConfig`, `linodeConfig`, `nutanixConfig`, `openstackConfig` and `vsphereConfig` (list maxitems:1)
	GoogleConfig *MachineConfigV2GoogleConfig `pulumi:"googleConfig"`
	// Harvester config for the Machine Config V2. Conflicts with `amazonec2Config`, `azureConfig`, `digitaloceanConfig`, `linodeConfig`, `nutanixConfig`, `openstackConfig`, `googleConfig` and `vsphereConfig` (list maxitems:1)
	...
	// Nutanix config for the Machine Config V2. Conflicts with `amazonec2Config`, `azureConfig`, `digitaloceanConfig`, `harvesterConfig`, `linodeConfig`, `openstackConfig`, `googleConfig` and `vsphereConfig` (list maxitems:1)
	NutanixConfig *MachineConfigV2NutanixConfig `pulumi:"nutanixConfig"`
	// Openstack config for the Machine Config V2. Conflicts with `amazonec2Config`, `azureConfig`, `digitaloceanConfig`, `harvesterConfig`, `linodeConfig`, `nutanixConfig`, `googleConfig` and `vsphereConfig` (list maxitems:1)
...
type MachineConfigV2State struct {
	...
	// Google config for the Machine Config V2. Conflicts with `amazonec2Config`, `azureConfig`, `digitaloceanConfig`, `harvesterConfig`, `linodeConfig`, `nutanixConfig`, `openstackConfig` and `vsphereConfig` (list maxitems:1)
	GoogleConfig MachineConfigV2GoogleConfigPtrInput
	// Harvester config for the Machine Config V2. Conflicts with `amazonec2Config`, `azureConfig`, `digitaloceanConfig`, `linodeConfig`, `nutanixConfig`, `openstackConfig`, `googleConfig` and `vsphereConfig` (list maxitems:1)
	...
	// Nutanix config for the Machine Config V2. Conflicts with `amazonec2Config`, `azureConfig`, `digitaloceanConfig`, `harvesterConfig`, `linodeConfig`, `openstackConfig`, `googleConfig` and `vsphereConfig` (list maxitems:1)
	NutanixConfig MachineConfigV2NutanixConfigPtrInput
	// Openstack config for the Machine Config V2. Conflicts with `amazonec2Config`, `azureConfig`, `digitaloceanConfig`, `harvesterConfig`, `linodeConfig`, `nutanixConfig`, `googleConfig` and `vsphereConfig` (list maxitems:1)
...
// Annotations for Machine Config V2 object (map)
func (o MachineConfigV2Output) Annotations() pulumi.StringMapOutput {
	return o.ApplyT(func(v *MachineConfigV2) pulumi.StringMapOutput { return v.Annotations }).(pulumi.StringMapOutput)
}
...
// Google config for the Machine Config V2. Conflicts with `amazonec2Config`, `azureConfig`, `digitaloceanConfig`, `harvesterConfig`, `linodeConfig`, `nutanixConfig`, `openstackConfig` and `vsphereConfig` (list maxitems:1)
func (o MachineConfigV2Output) GoogleConfig() MachineConfigV2GoogleConfigPtrOutput {
	return o.ApplyT(func(v *MachineConfigV2) MachineConfigV2GoogleConfigPtrOutput { return v.GoogleConfig }).(MachineConfigV2GoogleConfigPtrOutput)
}
...
//
// **Note:** `labels` and `nodeTaints` will be applied to nodes deployed using the Machine Config V2
func (o MachineConfigV2Output) Labels() pulumi.StringMapOutput {
	return o.ApplyT(func(v *MachineConfigV2) pulumi.StringMapOutput { return v.Labels }).(pulumi.StringMapOutput)
}
...
// Nutanix config for the Machine Config V2. Conflicts with `amazonec2Config`, `azureConfig`, `digitaloceanConfig`, `harvesterConfig`, `linodeConfig`, `openstackConfig`, `googleConfig` and `vsphereConfig` (list maxitems:1)
func (o MachineConfigV2Output) NutanixConfig() MachineConfigV2NutanixConfigPtrOutput {
	return o.ApplyT(func(v *MachineConfigV2) MachineConfigV2NutanixConfigPtrOutput { return v.NutanixConfig }).(MachineConfigV2NutanixConfigPtrOutput)
}
