...
func NewAuthConfigOpenLdap(ctx *pulumi.Context,
	name string, args *AuthConfigOpenLdapArgs, opts ...pulumi.ResourceOpt) (*AuthConfigOpenLdap, error) {
	...
	inputs["name"] = nil
	inputs["type"] = nil
	s, err := ctx.RegisterResource("rancher2:index/authConfigOpenLdap:AuthConfigOpenLdap", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &AuthConfigOpenLdap{s: s}, nil
}
...
func GetAuthConfigOpenLdap(ctx *pulumi.Context,
	name string, id pulumi.ID, state *AuthConfigOpenLdapState, opts ...pulumi.ResourceOpt) (*AuthConfigOpenLdap, error) {
	inputs := make(map[string]interface{})
	if state != nil {
	...
	s, err := ctx.ReadResource("rancher2:index/authConfigOpenLdap:AuthConfigOpenLdap", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &AuthConfigOpenLdap{s: s}, nil
...
func (r *AuthConfigOpenLdap) URN() pulumi.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *AuthConfigOpenLdap) ID() pulumi.IDOutput {
	return r.s.ID()
}

// Access mode for auth. `required`, `restricted`, `unrestricted` are supported. Default `unrestricted` (string)
func (r *AuthConfigOpenLdap) AccessMode() pulumi.StringOutput {
...
func (r *AuthConfigOpenLdap) AllowedPrincipalIds() pulumi.ArrayOutput {
	return (pulumi.ArrayOutput)(r.s.State["allowedPrincipalIds"])
}

// Annotations of the resource (map)
func (r *AuthConfigOpenLdap) Annotations() pulumi.MapOutput {
