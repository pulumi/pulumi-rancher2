...
export class AuthConfigCognito extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthConfigCognitoState, opts?: pulumi.CustomResourceOptions): AuthConfigCognito {
        return new AuthConfigCognito(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'rancher2:index/authConfigCognito:AuthConfigCognito';

    /**
     * Returns true if the given object is an instance of AuthConfigCognito.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AuthConfigCognito {
     ...
     */
    declare public readonly groupsField: pulumi.Output<string | undefined>;
    /**
     * The OIDC issuer URL.
     */
    ...
    constructor(name: string, argsOrState?: AuthConfigCognitoArgs | AuthConfigCognitoState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AuthConfigCognitoState | undefined;
            ...
            const args = argsOrState as AuthConfigCognitoArgs | undefined;
