...
export class AuthConfigPing extends pulumi.CustomResource {
     ...
     */
    declare public readonly entityIdField: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AuthConfigPingArgs | AuthConfigPingState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["entityIdField"] = state?.entityIdField;
            ...
            resourceInputs["entityIdField"] = args?.entityIdField;
