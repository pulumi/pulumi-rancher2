...
class GetNodeTemplateResult:
    ...
    def engine_env(self) -> Mapping[str, builtins.str]:
        """
    ...
    def engine_insecure_registries(self) -> Sequence[builtins.str]:
        """
    ...
    def engine_install_url(self) -> builtins.str:
        """
    ...
    def engine_label(self) -> Mapping[str, builtins.str]:
        """
    ...
    def engine_opt(self) -> Mapping[str, builtins.str]:
        """
    ...
    def engine_registry_mirrors(self) -> Sequence[builtins.str]:
        """
    ...
    def engine_storage_driver(self) -> builtins.str:
        """
    ...
    def use_internal_ip_address(self) -> Optional[builtins.bool]:
        """
...
def get_node_template(name: Optional[builtins.str] = None,
                      use_internal_ip_address: Optional[builtins.bool] = None,
    ...
    :param builtins.str name: The name of the Node Template (string)
    :param builtins.bool use_internal_ip_address: (Computed) Engine storage driver for the node template (bool)
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_node_template_output(name: Optional[pulumi.Input[builtins.str]] = None,
                             use_internal_ip_address: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
