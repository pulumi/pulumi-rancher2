...
def get_secret_v2(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: The cluster id of the secret V2 (string)
    :param builtins.str name: The name of the secret v2 (string)
    :param builtins.str namespace: The namespaces of the secret v2. Default: `default` (string)
    """
    __args__ = dict()
...
def get_secret_v2_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
