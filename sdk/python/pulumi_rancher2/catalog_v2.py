...
class CatalogV2Args:
    def __init__(__self__, *,
                 ...
                 exponential_backoff_max_retries: Optional[pulumi.Input[builtins.int]] = None,
                 exponential_backoff_max_wait: Optional[pulumi.Input[builtins.int]] = None,
                 exponential_backoff_min_wait: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 insecure_plain_http: Optional[pulumi.Input[builtins.bool]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 secret_name: Optional[pulumi.Input[builtins.str]] = None,
                 secret_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 service_account: Optional[pulumi.Input[builtins.str]] = None,
                 service_account_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CatalogV2 resource.
        :param pulumi.Input[builtins.str] cluster_id: The cluster id of the catalog V2 (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for the catalog v2 (map)
        :param pulumi.Input[builtins.str] ca_bundle: CA certificate in base64-encoded DER format which will be used to validate the repo's certificate (string)
        :param pulumi.Input[builtins.bool] enabled: If disabled the repo clone will not be updated or allowed to be installed from. Default: `true` (bool)
        :param pulumi.Input[builtins.int] exponential_backoff_max_retries: Maximum number of retries before returning error
        :param pulumi.Input[builtins.int] exponential_backoff_max_wait: Maximum amount of seconds to wait before retrying
        :param pulumi.Input[builtins.int] exponential_backoff_min_wait: Minimum amount of seconds to wait before retrying
        :param pulumi.Input[builtins.str] git_branch: Git Repository branch containing Helm chart definitions. Default `master` (string)
        :param pulumi.Input[builtins.str] git_repo: The url of the catalog v2 repo. Conflicts with `url` (string)
        :param pulumi.Input[builtins.bool] insecure: Use insecure HTTPS to download the repo's index. Default: `false` (bool)
        :param pulumi.Input[builtins.bool] insecure_plain_http: Only valid for OCI URL's. Allows insecure connections to registries without enforcing TLS checks
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the catalog v2 (map)
        :param pulumi.Input[builtins.str] name: The name of the catalog v2 (string)
        :param pulumi.Input[builtins.str] secret_name: K8s secret name to be used to connect to the repo (string)
        :param pulumi.Input[builtins.str] secret_namespace: K8s secret namespace (string)
        :param pulumi.Input[builtins.str] service_account: K8s service account used to deploy charts instead of the end users credentials (string)
        :param pulumi.Input[builtins.str] service_account_namespace: The username to access the catalog if needed (string)
        :param pulumi.Input[builtins.str] url: URL to an index generated by Helm. Conflicts with `git_repo` (string)
        """
    ...
    def exponential_backoff_max_retries(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def exponential_backoff_max_retries(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "exponential_backoff_max_retries", value)

    @property
    @pulumi.getter(name="exponentialBackoffMaxWait")
    def exponential_backoff_max_wait(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def exponential_backoff_max_wait(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "exponential_backoff_max_wait", value)

    @property
    @pulumi.getter(name="exponentialBackoffMinWait")
    def exponential_backoff_min_wait(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def exponential_backoff_min_wait(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def insecure_plain_http(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def insecure_plain_http(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def secret_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def secret_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_account_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_account_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CatalogV2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the catalog v2 (map)
        :param pulumi.Input[builtins.str] name: The name of the catalog v2 (string)
        :param pulumi.Input[builtins.str] resource_version: (Computed) The k8s resource version (string)
        :param pulumi.Input[builtins.str] secret_name: K8s secret name to be used to connect to the repo (string)
        :param pulumi.Input[builtins.str] secret_namespace: K8s secret namespace (string)
        :param pulumi.Input[builtins.str] service_account: K8s service account used to deploy charts instead of the end users credentials (string)
        :param pulumi.Input[builtins.str] service_account_namespace: The username to access the catalog if needed (string)
...
class CatalogV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_account: Optional[pulumi.Input[builtins.str]] = None,
            service_account_namespace: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'CatalogV2':
        """
    ...
    @property
    @pulumi.getter(name="caBundle")
    def ca_bundle(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        CA certificate in base64-encoded DER format which will be used to validate the repo's certificate (string)
        """
        return pulumi.get(self, "ca_bundle")
    ...
    @property
    @pulumi.getter(name="exponentialBackoffMaxRetries")
    def exponential_backoff_max_retries(self) -> pulumi.Output[builtins.int]:
        """
        Maximum number of retries before returning error
        """
        return pulumi.get(self, "exponential_backoff_max_retries")
    ...
    @property
    @pulumi.getter(name="exponentialBackoffMaxWait")
    def exponential_backoff_max_wait(self) -> pulumi.Output[builtins.int]:
        """
        Maximum amount of seconds to wait before retrying
        """
        return pulumi.get(self, "exponential_backoff_max_wait")
    ...
    @property
    @pulumi.getter(name="exponentialBackoffMinWait")
    def exponential_backoff_min_wait(self) -> pulumi.Output[builtins.int]:
        """
        Minimum amount of seconds to wait before retrying
        """
        return pulumi.get(self, "exponential_backoff_min_wait")
    ...
    @property
    @pulumi.getter(name="insecurePlainHttp")
    def insecure_plain_http(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Only valid for OCI URL's. Allows insecure connections to registries without enforcing TLS checks
        """
        return pulumi.get(self, "insecure_plain_http")
    ...
    @property
    @pulumi.getter(name="resourceVersion")
    def resource_version(self) -> pulumi.Output[builtins.str]:
        """
        (Computed) The k8s resource version (string)
        """
        return pulumi.get(self, "resource_version")
    ...
    @property
    @pulumi.getter(name="secretNamespace")
    def secret_namespace(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        K8s secret namespace (string)
        """
        return pulumi.get(self, "secret_namespace")
    ...
    @property
    @pulumi.getter(name="serviceAccountNamespace")
    def service_account_namespace(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The username to access the catalog if needed (string)
        """
        return pulumi.get(self, "service_account_namespace")
