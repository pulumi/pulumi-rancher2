...
class ConfigMapV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The cluster id of the configMap V2 (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] data: The data of the configMap v2 (map)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for the configMap v2 (map)
        :param pulumi.Input[builtins.bool] immutable: If set to true, any configMap update will remove and recreate the configMap. This is a beta field enabled by k8s `ImmutableEphemeralVolumes` feature gate. Default: `false` (bool)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the configMap v2 (map)
        :param pulumi.Input[builtins.str] name: The name of the configMap v2 (string)
        :param pulumi.Input[builtins.str] namespace: The namespaces of the configMap v2. Default: `default` (string)
        """
...
class ConfigMapV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            resource_version: Optional[pulumi.Input[builtins.str]] = None) -> 'ConfigMapV2':
        """
