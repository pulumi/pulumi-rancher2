...
class NodeDriverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] active: Specify if the node driver state (bool)
        :param pulumi.Input[builtins.bool] builtin: Specify wheter the node driver is an internal node driver or not (bool)
        ...
        :param pulumi.Input[builtins.str] description: Description of the node driver (string)
        :param pulumi.Input[builtins.str] external_id: External ID (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels of the resource (map)
        :param pulumi.Input[builtins.str] name: Name of the node driver (string)
        :param pulumi.Input[builtins.str] ui_url: The URL to load for customized Add Nodes screen for this driver (string)
...
class NodeDriver(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ui_url: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            whitelist_domains: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'NodeDriver':
        """
