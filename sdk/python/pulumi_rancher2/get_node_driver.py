...
def get_node_driver(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of the node driver (string)
...
def get_node_driver_output(name: Optional[pulumi.Input[builtins.str]] = None,
