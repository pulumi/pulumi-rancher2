...
class CatalogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] url: The url of the catalog repo (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for the catalog (map)
        :param pulumi.Input[builtins.str] branch: The branch of the catalog repo to use. Default `master` (string)
        :param pulumi.Input[builtins.str] cluster_id: The cluster id of the catalog. Mandatory if `scope = cluster` (string)
        :param pulumi.Input[builtins.str] description: A catalog description (string)
        :param pulumi.Input[builtins.str] kind: The kind of the catalog. Just helm by the moment (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the catalog (map)
        :param pulumi.Input[builtins.str] name: The name of the catalog (string)
        :param pulumi.Input[builtins.str] password: The password to access the catalog if needed (string)
        :param pulumi.Input[builtins.str] project_id: The project id of the catalog. Mandatory if `scope = project` (string)
        :param pulumi.Input[builtins.bool] refresh: Catalog will wait for refresh after tf creation and on every tf read. Default `false` (bool)
        :param pulumi.Input[builtins.str] scope: The scope of the catalog. `cluster`, `global`, and `project` are supported. Default `global` (string)
        :param pulumi.Input[builtins.str] username: The username to access the catalog if needed (string)
        :param pulumi.Input[builtins.str] version: Helm version for the catalog. Available options: `helm_v2` and `helm_v3` (string)
        """
...
class Catalog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'Catalog':
        """
