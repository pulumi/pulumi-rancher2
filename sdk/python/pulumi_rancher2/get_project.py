...
def get_project(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: ID of the Rancher 2 cluster (string)
    :param builtins.str name: The project name (string)
    """
    __args__ = dict()
...
def get_project_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
