...
def get_etcd_backup(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: Cluster ID to config Etcd Backup (string)
    :param builtins.str name: The name of the Etcd Backup (string)
    """
    __args__ = dict()
...
def get_etcd_backup_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
