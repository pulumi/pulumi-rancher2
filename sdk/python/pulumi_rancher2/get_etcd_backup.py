...
class GetEtcdBackupResult:
    ...
    @_builtins.property
    @pulumi.getter
    def manual(self) -> _builtins.bool:
        """
...
def get_etcd_backup(cluster_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cluster_id: Cluster ID to config Etcd Backup (string)
    :param _builtins.str name: The name of the Etcd Backup (string)
    """
    __args__ = dict()
...
def get_etcd_backup_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
