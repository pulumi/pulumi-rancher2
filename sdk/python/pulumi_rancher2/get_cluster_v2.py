...
class GetClusterV2Result:
    ...
    def cloud_credential_secret_name(self) -> builtins.str:
        """
    ...
    def cluster_v1_id(self) -> builtins.str:
        """
    ...
    def fleet_namespace(self) -> Optional[builtins.str]:
...
def get_cluster_v2(fleet_namespace: Optional[builtins.str] = None,
    ...
    :param builtins.str fleet_namespace: The fleet namespace of the Cluster v2. Default: `\\"fleet-default\\"` (string)
...
def get_cluster_v2_output(fleet_namespace: Optional[pulumi.Input[Optional[builtins.str]]] = None,
