...
class AppArgs:
    def __init__(__self__, *,
                 ...
                 values_yaml: Optional[pulumi.Input[builtins.str]] = None,
                 wait: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a App resource.
        :param pulumi.Input[builtins.str] catalog_name: Catalog name of the app. If modified, app will be upgraded. For use scoped catalogs:
               * add cluster ID before name, `local:<name>` or `c-XXXXX:<name>`
               * add project ID before name, `p-XXXXX:<name>`
        :param pulumi.Input[builtins.str] project_id: The project id where the app will be installed (string)
        :param pulumi.Input[builtins.str] target_namespace: The namespace id where the app will be installed (string)
        :param pulumi.Input[builtins.str] template_name: Template name of the app. If modified, app will be upgraded (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for App object (map)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] answers: Answers for the app template. If modified, app will be upgraded (map)
        :param pulumi.Input[builtins.str] description: Description for the app (string)
        :param pulumi.Input[builtins.bool] force_upgrade: Force app upgrade (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for App object (map)
        :param pulumi.Input[builtins.str] name: The name of the app (string)
        :param pulumi.Input[builtins.str] revision_id: Current revision id for the app. If modified, If this argument is provided or modified, app will be rollbacked to `revision_id` (string)
        :param pulumi.Input[builtins.str] template_version: Template version of the app. If modified, app will be upgraded. Default: `latest` (string)
        :param pulumi.Input[builtins.str] values_yaml: values.yaml base64 encoded file content for the app template. If modified, app will be upgraded (string)
        :param pulumi.Input[builtins.bool] wait: Wait until app is deployed and active. Default: `true` (bool)
        """
    ...
    def target_namespace(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_namespace(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def answers(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    @answers.setter
    def answers(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def values_yaml(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @values_yaml.setter
    def values_yaml(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AppState:
    def __init__(__self__, *,
                 ...
                 revision_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_namespace: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] catalog_name: Catalog name of the app. If modified, app will be upgraded. For use scoped catalogs:
               ...
               * add project ID before name, `p-XXXXX:<name>`
        :param pulumi.Input[builtins.str] description: Description for the app (string)
        :param pulumi.Input[builtins.str] external_id: (Computed) The url of the app template on a catalog (string)
        :param pulumi.Input[builtins.bool] force_upgrade: Force app upgrade (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for App object (map)
        :param pulumi.Input[builtins.str] name: The name of the app (string)
        :param pulumi.Input[builtins.str] project_id: The project id where the app will be installed (string)
    ...
    @property
    @pulumi.getter(name="targetNamespace")
    def target_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The namespace id where the app will be installed (string)
        """
        return pulumi.get(self, "target_namespace")
    ...
    @target_namespace.setter
    def target_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_namespace", value)
...
class App(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            template_version: Optional[pulumi.Input[builtins.str]] = None,
            values_yaml: Optional[pulumi.Input[builtins.str]] = None,
            wait: Optional[pulumi.Input[builtins.bool]] = None) -> 'App':
        """
    ...
    @property
    @pulumi.getter
    def answers(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Answers for the app template. If modified, app will be upgraded (map)
        """
        return pulumi.get(self, "answers")
    ...
    @property
    @pulumi.getter(name="targetNamespace")
    def target_namespace(self) -> pulumi.Output[builtins.str]:
        """
        The namespace id where the app will be installed (string)
        """
        return pulumi.get(self, "target_namespace")
    ...
    @property
    @pulumi.getter(name="valuesYaml")
    def values_yaml(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        values.yaml base64 encoded file content for the app template. If modified, app will be upgraded (string)
        """
        return pulumi.get(self, "values_yaml")
