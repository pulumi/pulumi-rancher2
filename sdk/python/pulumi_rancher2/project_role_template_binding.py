...
class ProjectRoleTemplateBindingArgs:
    def __init__(__self__, *,
                 ...
                 role_template_id: pulumi.Input[builtins.str],
                 ...
                 group_principal_id: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 user_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_principal_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ProjectRoleTemplateBinding resource.
        :param pulumi.Input[builtins.str] project_id: The project id where bind project role template, in format `cluster_id:project_id`, e.g. `c-abc12:p-def34` (string)
        :param pulumi.Input[builtins.str] role_template_id: The role template id from create project role template binding (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations of the resource (map)
        :param pulumi.Input[builtins.str] group_id: The group ID to assign project role template binding (string)
        :param pulumi.Input[builtins.str] group_principal_id: The group_principal ID to assign project role template binding (string)
        ...
        :param pulumi.Input[builtins.str] name: The name of the project role template binding (string)
        :param pulumi.Input[builtins.str] user_id: The user ID to assign project role template binding (string)
        :param pulumi.Input[builtins.str] user_principal_id: The user_principal ID to assign project role template binding (string)
        """
    ...
    def role_template_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def role_template_id(self, value: pulumi.Input[builtins.str]):
    ...
    def group_principal_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def group_principal_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_principal_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_principal_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProjectRoleTemplateBindingState:
    def __init__(__self__, *,
                 ...
                 role_template_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_principal_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="roleTemplateId")
    def role_template_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The role template id from create project role template binding (string)
        """
        return pulumi.get(self, "role_template_id")
    ...
    @role_template_id.setter
    def role_template_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "role_template_id", value)
...
@pulumi.type_token("rancher2:index/projectRoleTemplateBinding:ProjectRoleTemplateBinding")
class ProjectRoleTemplateBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_template_id: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None,
            user_principal_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectRoleTemplateBinding':
        """
    ...
    @property
    @pulumi.getter(name="groupPrincipalId")
    def group_principal_id(self) -> pulumi.Output[builtins.str]:
        """
        The group_principal ID to assign project role template binding (string)
        """
        return pulumi.get(self, "group_principal_id")
    ...
    @property
    @pulumi.getter(name="roleTemplateId")
    def role_template_id(self) -> pulumi.Output[builtins.str]:
        """
        The role template id from create project role template binding (string)
        """
        return pulumi.get(self, "role_template_id")
    ...
    @property
    @pulumi.getter(name="userPrincipalId")
    def user_principal_id(self) -> pulumi.Output[builtins.str]:
        """
        The user_principal ID to assign project role template binding (string)
        """
        return pulumi.get(self, "user_principal_id")
