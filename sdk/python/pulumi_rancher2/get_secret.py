...
def get_secret(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the secret (string)
    :param _builtins.str namespace_id: The namespace id where to assign the namespaced secret (string)
    :param _builtins.str project_id: The project id where to assign the secret (string)
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_secret_output(name: Optional[pulumi.Input[_builtins.str]] = None,
