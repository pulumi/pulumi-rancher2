...
def get_secret(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the secret (string)
    :param builtins.str namespace_id: The namespace id where to assign the namespaced secret (string)
    :param builtins.str project_id: The project id where to assign the secret (string)
    """
    __args__ = dict()
    __args__['name'] = name
