...
class NamespaceArgs:
    def __init__(__self__, *,
                 ...
                 wait_for_cluster: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Namespace resource.
        :param pulumi.Input[builtins.str] project_id: The project id where assign namespace. It's on the form `project_id=<cluster_id>:<id>`. Updating `<id>` part on same `<cluster_id>` namespace will be moved between projects (string)
        ...
        :param pulumi.Input[builtins.str] description: A namespace description (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for Node Pool object (map)
        :param pulumi.Input[builtins.str] name: The name of the namespace (string)
        ...
        :param pulumi.Input[builtins.bool] wait_for_cluster: Wait for cluster becomes active. Default `false` (bool)
        """
    ...
    def wait_for_cluster(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def wait_for_cluster(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Namespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_quota: Optional[pulumi.Input[Union['NamespaceResourceQuotaArgs', 'NamespaceResourceQuotaArgsDict']]] = None,
            wait_for_cluster: Optional[pulumi.Input[builtins.bool]] = None) -> 'Namespace':
        """
    ...
    @property
    @pulumi.getter(name="waitForCluster")
    def wait_for_cluster(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Wait for cluster becomes active. Default `false` (bool)
        """
        return pulumi.get(self, "wait_for_cluster")
