...
class ClusterAlertGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] annotations: The cluster alert group annotations (map)
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: The cluster alert group labels (map)
