...
class SecretV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The cluster id of the secret V2 (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] data: The data of the secret v2 (map)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for the secret v2 (map)
        :param pulumi.Input[builtins.bool] immutable: If set to true, any secret update will remove and recreate the secret. This is a beta field enabled by k8s `ImmutableEphemeralVolumes` feature gate. Default: `false` (bool)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the secret v2 (map)
        :param pulumi.Input[builtins.str] name: The name of the secret v2 (string)
        :param pulumi.Input[builtins.str] namespace: The namespaces of the secret v2. Default: `default` (string)
        :param pulumi.Input[builtins.str] type: The type of the k8s secret, used to facilitate programmatic handling of secret data, [More info](https://github.com/kubernetes/api/blob/release-1.20/core/v1/types.go#L5772) about k8s secret types and expected format.  Default: `Opaque` (string)
        """
...
class SecretV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            resource_version: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'SecretV2':
        """
