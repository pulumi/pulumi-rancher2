...
class AuthConfigOktaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name_field: OKTA display name field (string)
        :param pulumi.Input[builtins.str] groups_field: OKTA group field (string)
        :param pulumi.Input[builtins.str] idp_metadata_content: OKTA IDP metadata content (string)
        ...
        :param pulumi.Input[builtins.str] sp_cert: OKTA SP cert (string)
        :param pulumi.Input[builtins.str] sp_key: OKTA SP key (string)
        :param pulumi.Input[builtins.str] uid_field: OKTA UID field (string)
        :param pulumi.Input[builtins.str] user_name_field: OKTA user name field (string)
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_principal_ids: Allowed principal ids for auth. Required if `access_mode` is `required` or `restricted`. Ex: `okta_user://<USER_ID>`  `okta_group://<GROUP_ID>` (list)
...
@pulumi.type_token("rancher2:index/authConfigOkta:AuthConfigOkta")
class AuthConfigOkta(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            uid_field: Optional[pulumi.Input[builtins.str]] = None,
            user_name_field: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthConfigOkta':
        """
