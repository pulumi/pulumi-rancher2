...
class AuthConfigFreeIpaArgs:
    def __init__(__self__, *,
        ...
        """
        AuthConfigFreeIpaArgs._configure(
...
class _AuthConfigFreeIpaState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] user_search_base: User search base DN (string)
        """
        _AuthConfigFreeIpaState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            access_mode=access_mode,
            allowed_principal_ids=allowed_principal_ids,
            annotations=annotations,
...
class AuthConfigFreeIpa(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AuthConfigFreeIpaArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            user_search_attribute: Optional[pulumi.Input[str]] = None,
            user_search_base: Optional[pulumi.Input[str]] = None,
            user_search_filter: Optional[pulumi.Input[str]] = None) -> 'AuthConfigFreeIpa':
        """
