...
class AppV2Args:
    def __init__(__self__, *,
                 chart_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] chart_name: The app v2 chart name (string)
        :param pulumi.Input[builtins.str] cluster_id: The cluster id of the app (string)
        :param pulumi.Input[builtins.str] namespace: The namespace of the app v2 (string)
        :param pulumi.Input[builtins.str] repo_name: Repo name (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for the app v2 (map)
        :param pulumi.Input[builtins.str] chart_version: The app v2 chart version (string)
        :param pulumi.Input[builtins.bool] cleanup_on_fail: Cleanup app v2 on failed chart upgrade. Default: `false` (bool)
        :param pulumi.Input[builtins.bool] disable_hooks: Disable app v2 chart hooks. Default: `false` (bool)
        :param pulumi.Input[builtins.bool] disable_open_api_validation: Disable app V2 Open API Validation. Default: `false` (bool)
        :param pulumi.Input[builtins.bool] force_upgrade: Force app V2 chart upgrade. Default: `false` (bool)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the app v2 (map)
        :param pulumi.Input[builtins.str] name: The name of the app v2 (string)
        :param pulumi.Input[builtins.str] project_id: Deploy the app v2 within project ID (string)
        :param pulumi.Input[builtins.str] system_default_registry: System default registry providing images for app deployment (string)
        :param pulumi.Input[builtins.str] values: The app v2 values yaml. Yaml format is required (string)
        :param pulumi.Input[builtins.bool] wait: Wait until app is deployed. Default: `true` (bool)
        """
    ...
    def chart_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @chart_name.setter
    def chart_name(self, value: pulumi.Input[builtins.str]):
    ...
    def chart_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def chart_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def disable_open_api_validation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_open_api_validation(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def system_default_registry(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_default_registry(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AppV2State:
    def __init__(__self__, *,
                 annotations: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 chart_name: Optional[pulumi.Input[builtins.str]] = None,
                 chart_version: Optional[pulumi.Input[builtins.str]] = None,
                 cleanup_on_fail: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] cleanup_on_fail: Cleanup app v2 on failed chart upgrade. Default: `false` (bool)
        :param pulumi.Input[builtins.str] cluster_id: The cluster id of the app (string)
        :param pulumi.Input[builtins.str] cluster_name: (Computed) The cluster name of the app (string)
        :param pulumi.Input[builtins.bool] disable_hooks: Disable app v2 chart hooks. Default: `false` (bool)
        :param pulumi.Input[builtins.bool] disable_open_api_validation: Disable app V2 Open API Validation. Default: `false` (bool)
        :param pulumi.Input[builtins.bool] force_upgrade: Force app V2 chart upgrade. Default: `false` (bool)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the app v2 (map)
    ...
    @property
    @pulumi.getter(name="chartName")
    def chart_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The app v2 chart name (string)
        """
        return pulumi.get(self, "chart_name")
    ...
    @chart_name.setter
    def chart_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "chart_name", value)
...
class AppV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_default_registry: Optional[pulumi.Input[builtins.str]] = None,
            values: Optional[pulumi.Input[builtins.str]] = None,
            wait: Optional[pulumi.Input[builtins.bool]] = None) -> 'AppV2':
        """
    ...
    @property
    @pulumi.getter(name="chartName")
    def chart_name(self) -> pulumi.Output[builtins.str]:
        """
        The app v2 chart name (string)
        """
        return pulumi.get(self, "chart_name")
    ...
    @property
    @pulumi.getter(name="chartVersion")
    def chart_version(self) -> pulumi.Output[builtins.str]:
        """
        The app v2 chart version (string)
        """
        return pulumi.get(self, "chart_version")
    ...
    @property
    @pulumi.getter(name="deploymentValues")
    def deployment_values(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "deployment_values")

    @property
    @pulumi.getter(name="disableHooks")
    def disable_hooks(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Disable app v2 chart hooks. Default: `false` (bool)
        """
        return pulumi.get(self, "disable_hooks")
    ...
    @property
    @pulumi.getter(name="disableOpenApiValidation")
    def disable_open_api_validation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Disable app V2 Open API Validation. Default: `false` (bool)
        """
        return pulumi.get(self, "disable_open_api_validation")
    ...
    @property
    @pulumi.getter(name="systemDefaultRegistry")
    def system_default_registry(self) -> pulumi.Output[builtins.str]:
        """
        System default registry providing images for app deployment (string)
        """
        return pulumi.get(self, "system_default_registry")
