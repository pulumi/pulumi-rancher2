...
class AppV2Args:
    def __init__(__self__, *,
                 chart_name: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.bool] cleanup_on_fail: Cleanup app v2 on failed chart upgrade. Default: `false` (bool)
        :param pulumi.Input[_builtins.bool] disable_hooks: Disable app v2 chart hooks. Default: `false` (bool)
        :param pulumi.Input[_builtins.bool] disable_open_api_validation: Disable app V2 Open API Validation. Default: `false` (bool)
        :param pulumi.Input[_builtins.bool] force_upgrade: Force app V2 chart upgrade. Default: `false` (bool)
    ...
    def chart_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @chart_name.setter
    def chart_name(self, value: pulumi.Input[_builtins.str]):
...
class _AppV2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] cleanup_on_fail: Cleanup app v2 on failed chart upgrade. Default: `false` (bool)
        :param pulumi.Input[_builtins.str] cluster_id: The cluster id of the app (string)
        :param pulumi.Input[_builtins.str] cluster_name: (Computed) The cluster name of the app (string)
        :param pulumi.Input[_builtins.str] deployment_values: Values YAML file including computed values. This field prevents incorrect discrepancies from showing in the terraform plan output when files change but values stay the same, due to additional computed values included by the provider itself.
        :param pulumi.Input[_builtins.bool] disable_hooks: Disable app v2 chart hooks. Default: `false` (bool)
        :param pulumi.Input[_builtins.bool] disable_open_api_validation: Disable app V2 Open API Validation. Default: `false` (bool)
        :param pulumi.Input[_builtins.bool] force_upgrade: Force app V2 chart upgrade. Default: `false` (bool)
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels for the app v2 (map)
...
class AppV2(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="deploymentValues")
    def deployment_values(self) -> pulumi.Output[_builtins.str]:
        """
        Values YAML file including computed values. This field prevents incorrect discrepancies from showing in the terraform plan output when files change but values stay the same, due to additional computed values included by the provider itself.
        """
        return pulumi.get(self, "deployment_values")
    ...
    @_builtins.property
    @pulumi.getter(name="disableHooks")
    def disable_hooks(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Disable app v2 chart hooks. Default: `false` (bool)
        """
        return pulumi.get(self, "disable_hooks")
    ...
    @_builtins.property
    @pulumi.getter(name="disableOpenApiValidation")
    def disable_open_api_validation(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Disable app V2 Open API Validation. Default: `false` (bool)
        """
        return pulumi.get(self, "disable_open_api_validation")
    ...
    @_builtins.property
    @pulumi.getter(name="systemDefaultRegistry")
    def system_default_registry(self) -> pulumi.Output[_builtins.str]:
        """
        System default registry providing images for app deployment (string)
        """
        return pulumi.get(self, "system_default_registry")
