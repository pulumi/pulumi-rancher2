...
class GetClusterDriverResult:
    ...
    def actual_url(self) -> builtins.str:
        """
    ...
    def whitelist_domains(self) -> Sequence[builtins.str]:
        """
...
def get_cluster_driver(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of the cluster driver (string)
    :param builtins.str url: The URL to download the machine driver binary for 64-bit Linux (string)
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['url'] = url
...
def get_cluster_driver_output(name: Optional[pulumi.Input[builtins.str]] = None,
