...
class GetRoleTemplateResult:
    ...
    @property
    @pulumi.getter
    def administrative(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def builtin(self) -> builtins.bool:
        """
    ...
    def default_role(self) -> builtins.bool:
        """
    ...
    def role_template_ids(self) -> Sequence[builtins.str]:
        """
...
def get_role_template(context: Optional[builtins.str] = None,
    ...
    :param builtins.str context: Role template context. `cluster` and `project` values are supported (string)
    ...
    :param builtins.str name: The name of the Role Template (string)
    """
    __args__ = dict()
...
def get_role_template_output(context: Optional[pulumi.Input[Optional[builtins.str]]] = None,
