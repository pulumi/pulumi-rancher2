...
def get_config_map_v2(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: The cluster id of the configMap V2 (string)
    :param builtins.str name: The name of the configMap v2 (string)
    :param builtins.str namespace: The namespaces of the configMap v2. Default: `default` (string)
    """
    __args__ = dict()
...
def get_config_map_v2_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
