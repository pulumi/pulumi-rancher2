...
def get_cloud_credential(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The Cloud Credential name.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_cloud_credential_output(name: Optional[pulumi.Input[builtins.str]] = None,
