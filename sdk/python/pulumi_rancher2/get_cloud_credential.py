...
def get_cloud_credential(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The Cloud Credential name.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_cloud_credential_output(name: Optional[pulumi.Input[_builtins.str]] = None,
