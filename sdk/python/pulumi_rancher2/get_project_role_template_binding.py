...
def get_project_role_template_binding(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the project role template binding (string)
    :param _builtins.str project_id: The project id where bind project role template (string)
    :param _builtins.str role_template_id: The role template id from create project role template binding (string)
    """
    __args__ = dict()
    __args__['name'] = name
