...
def get_project_role_template_binding(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the project role template binding (string)
    :param builtins.str project_id: The project id where bind project role template (string)
    :param builtins.str role_template_id: The role template id from create project role template binding (string)
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_project_role_template_binding_output(name: Optional[pulumi.Input[builtins.str]] = None,
