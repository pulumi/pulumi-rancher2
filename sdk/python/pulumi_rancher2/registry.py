...
class RegistryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: The project id where to assign the registry (string)
        :param pulumi.Input[Sequence[pulumi.Input['RegistryRegistryArgs']]] registries: Registries data for registry (list)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for Registry object (map)
        :param pulumi.Input[builtins.str] description: A registry description (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for Registry object (map)
        :param pulumi.Input[builtins.str] name: The name of the registry (string)
        :param pulumi.Input[builtins.str] namespace_id: The namespace id where to assign the namespaced registry (string)
        """
