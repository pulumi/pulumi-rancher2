...
class GetMultiClusterAppResult:
    ...
    def revision_history_limit(self) -> builtins.int:
        """
    ...
    def template_version_id(self) -> builtins.str:
        """
...
def get_multi_cluster_app(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The multi cluster app name (string)
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_multi_cluster_app_output(name: Optional[pulumi.Input[builtins.str]] = None,
