...
class ClusterTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for the cluster template (map)
        :param pulumi.Input[builtins.str] description: Cluster template description
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the cluster template (map)
        :param pulumi.Input[Sequence[pulumi.Input['ClusterTemplateMemberArgs']]] members: Cluster template members (list)
        :param pulumi.Input[builtins.str] name: The cluster template name (string)
...
class _ClusterTemplateState:
    def __init__(__self__, *,
                 annotations: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 default_revision_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterTemplateMemberArgs']]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for the cluster template (map)
        :param pulumi.Input[builtins.str] default_revision_id: (Computed) Default cluster template revision ID (string)
        :param pulumi.Input[builtins.str] description: Cluster template description
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the cluster template (map)
        :param pulumi.Input[Sequence[pulumi.Input['ClusterTemplateMemberArgs']]] members: Cluster template members (list)
        :param pulumi.Input[builtins.str] name: The cluster template name (string)
    ...
    def default_revision_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_revision_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterTemplate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultRevisionId")
    def default_revision_id(self) -> pulumi.Output[builtins.str]:
        """
        (Computed) Default cluster template revision ID (string)
        """
        return pulumi.get(self, "default_revision_id")
