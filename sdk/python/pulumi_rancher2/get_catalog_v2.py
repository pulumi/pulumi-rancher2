...
class GetCatalogV2Result:
    ...
    def insecure_plain_http(self) -> Optional[_builtins.bool]:
...
def get_catalog_v2(cluster_id: Optional[_builtins.str] = None,
                   exponential_backoff_max_retries: Optional[_builtins.int] = None,
                   exponential_backoff_max_wait: Optional[_builtins.int] = None,
                   exponential_backoff_min_wait: Optional[_builtins.int] = None,
                   insecure_plain_http: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str cluster_id: The cluster id of the catalog V2 (string)
    :param _builtins.str name: The name of the catalog v2 (string)
    """
    __args__ = dict()
...
def get_catalog_v2_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                          exponential_backoff_max_retries: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                          exponential_backoff_max_wait: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                          exponential_backoff_min_wait: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                          insecure_plain_http: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
