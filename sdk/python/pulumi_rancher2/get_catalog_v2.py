...
class GetCatalogV2Result:
    ...
    def insecure_plain_http(self) -> Optional[builtins.bool]:
...
def get_catalog_v2(cluster_id: Optional[builtins.str] = None,
                   exponential_backoff_max_retries: Optional[builtins.int] = None,
                   exponential_backoff_max_wait: Optional[builtins.int] = None,
                   exponential_backoff_min_wait: Optional[builtins.int] = None,
                   insecure_plain_http: Optional[builtins.bool] = None,
    ...
    :param builtins.str cluster_id: The cluster id of the catalog V2 (string)
    :param builtins.str name: The name of the catalog v2 (string)
    """
    __args__ = dict()
...
def get_catalog_v2_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                          exponential_backoff_max_retries: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                          exponential_backoff_max_wait: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                          exponential_backoff_min_wait: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                          insecure_plain_http: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
