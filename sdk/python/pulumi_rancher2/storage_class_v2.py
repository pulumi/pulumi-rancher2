...
class StorageClassV2Args:
    def __init__(__self__, *,
                 ...
                 k8s_provisioner: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] cluster_id: The cluster id of the storageClass V2 (string)
        :param pulumi.Input[builtins.str] k8s_provisioner: The provisioner of the storageClass v2 (string)
        :param pulumi.Input[builtins.bool] allow_volume_expansion: Is the provisioner of the storageClass v2 allowing volume expansion? (bool)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for the storageClass v2 (map)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the storageClass v2 (map)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] mount_options: The mount options for storageClass v2 (list)
        :param pulumi.Input[builtins.str] name: The name of the storageClass v2 (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: The parameters for storageClass v2 (string)
        :param pulumi.Input[builtins.str] reclaim_policy: The reclaim policy for storageClass v2. `Delete`, `Recycle` and `Retain` values are allowed. Default: `Delete` (string)
        :param pulumi.Input[builtins.str] volume_binding_mode: The volume binding mode for storageClass v2. `Immediate` and `WaitForFirstConsumer` values are allowed. Default: `Immediate` (string)
        """
    ...
    def k8s_provisioner(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def k8s_provisioner(self, value: pulumi.Input[builtins.str]):
...
class _StorageClassV2State:
    def __init__(__self__, *,
                 ...
                 k8s_provisioner: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 mount_options: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="k8sProvisioner")
    def k8s_provisioner(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The provisioner of the storageClass v2 (string)
        """
        return pulumi.get(self, "k8s_provisioner")
    ...
    @k8s_provisioner.setter
    def k8s_provisioner(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "k8s_provisioner", value)
...
class StorageClassV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reclaim_policy: Optional[pulumi.Input[builtins.str]] = None,
            resource_version: Optional[pulumi.Input[builtins.str]] = None,
            volume_binding_mode: Optional[pulumi.Input[builtins.str]] = None) -> 'StorageClassV2':
        """
    ...
    @property
    @pulumi.getter(name="allowVolumeExpansion")
    def allow_volume_expansion(self) -> pulumi.Output[builtins.bool]:
        """
        Is the provisioner of the storageClass v2 allowing volume expansion? (bool)
        """
        return pulumi.get(self, "allow_volume_expansion")
    ...
    @property
    @pulumi.getter(name="k8sProvisioner")
    def k8s_provisioner(self) -> pulumi.Output[builtins.str]:
        """
        The provisioner of the storageClass v2 (string)
        """
        return pulumi.get(self, "k8s_provisioner")
    ...
    @property
    @pulumi.getter(name="mountOptions")
    def mount_options(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The mount options for storageClass v2 (list)
        """
        return pulumi.get(self, "mount_options")
    ...
    @property
    @pulumi.getter(name="reclaimPolicy")
    def reclaim_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The reclaim policy for storageClass v2. `Delete`, `Recycle` and `Retain` values are allowed. Default: `Delete` (string)
        """
        return pulumi.get(self, "reclaim_policy")
