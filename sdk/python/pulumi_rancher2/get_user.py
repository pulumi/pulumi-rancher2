...
class GetUserResult:
    ...
    def is_external(self) -> Optional[builtins.bool]:
    ...
    def must_change_password(self) -> builtins.bool:
        """
    ...
    def principal_ids(self) -> Sequence[builtins.str]:
        """
...
def get_user(is_external: Optional[builtins.bool] = None,
    ...
    :param builtins.bool is_external: Set is the user if the user is external. Default: `false` (bool)
    :param builtins.str name: The name of the user (string)
    :param builtins.str username: The username of the user (string)
    """
    __args__ = dict()
...
def get_user_output(is_external: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
