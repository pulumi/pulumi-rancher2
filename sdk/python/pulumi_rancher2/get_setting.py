...
def get_setting(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The setting name.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_setting_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('rancher2:index/getSetting:getSetting', __args__, opts=opts, typ=GetSettingResult)
