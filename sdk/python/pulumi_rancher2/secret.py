...
class SecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] data: Secret key/value data. Base64 encoding required for values (map)
        :param pulumi.Input[builtins.str] project_id: The project id where to assign the secret (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for secret object (map)
        :param pulumi.Input[builtins.str] description: A secret description (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for secret object (map)
        :param pulumi.Input[builtins.str] name: The name of the secret (string)
        :param pulumi.Input[builtins.str] namespace_id: The namespace id where to assign the namespaced secret (string)
        """
...
class Secret(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            namespace_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Secret':
        """
