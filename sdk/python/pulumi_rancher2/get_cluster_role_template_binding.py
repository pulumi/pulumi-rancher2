...
class GetClusterRoleTemplateBindingResult:
    ...
    def role_template_id(self) -> _builtins.str:
...
def get_cluster_role_template_binding(cluster_id: Optional[_builtins.str] = None,
                                      name: Optional[_builtins.str] = None,
                                      role_template_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cluster_id: The cluster id where bind cluster role template (string)
    :param _builtins.str name: The name of the cluster role template binding (string)
    :param _builtins.str role_template_id: The role template id from create cluster role template binding (string)
    """
    __args__ = dict()
