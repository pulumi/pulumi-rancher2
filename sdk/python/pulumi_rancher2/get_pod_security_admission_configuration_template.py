...
def get_pod_security_admission_configuration_template(annotations: Optional[Mapping[str, builtins.str]] = None,
...
def get_pod_security_admission_configuration_template_output(annotations: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
