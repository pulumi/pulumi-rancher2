...
def get_pod_security_admission_configuration_template(annotations: Optional[Mapping[str, _builtins.str]] = None,
    ...
    :param Mapping[str, _builtins.str] annotations: (Computed) Annotations of the resource (map)
    :param Mapping[str, _builtins.str] labels: (Computed) Labels of the resource (map)
    :param _builtins.str name: The name of the pod security admission configuration template (string)
    """
    __args__ = dict()
