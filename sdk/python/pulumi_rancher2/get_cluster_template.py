...
class GetClusterTemplateResult:
    ...
    def default_revision_id(self) -> _builtins.str:
        """
...
def get_cluster_template(annotations: Optional[Mapping[str, _builtins.str]] = None,
...
def get_cluster_template_output(annotations: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = None,
