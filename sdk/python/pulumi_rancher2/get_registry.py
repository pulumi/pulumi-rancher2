...
def get_registry(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the registry (string)
    :param builtins.str namespace_id: The namespace id where to assign the namespaced registry (string)
    :param builtins.str project_id: The project id where to assign the registry (string)
    """
    __args__ = dict()
    __args__['name'] = name
