...
def get_registry(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the registry (string)
    :param _builtins.str namespace_id: The namespace id where to assign the namespaced registry (string)
    :param _builtins.str project_id: The project id where to assign the registry (string)
    """
    __args__ = dict()
    __args__['name'] = name
