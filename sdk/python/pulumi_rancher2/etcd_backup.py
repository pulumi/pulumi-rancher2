...
class EtcdBackupArgs:
    def __init__(__self__, *,
                 ...
                 manual: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EtcdBackup resource.
        :param pulumi.Input[builtins.str] cluster_id: Cluster ID to config Etcd Backup (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for Etcd Backup object (map)
        :param pulumi.Input['EtcdBackupBackupConfigArgs'] backup_config: Backup config for etcd backup (list maxitems:1)
        :param pulumi.Input[builtins.str] filename: Filename of the Etcd Backup (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for Etcd Backup object (map)
        :param pulumi.Input[builtins.bool] manual: Manual execution of the Etcd Backup. Default `false` (bool)
        :param pulumi.Input[builtins.str] name: The name of the Etcd Backup (string)
        :param pulumi.Input[builtins.str] namespace_id: Description for the Etcd Backup (string)
        """
    ...
    @property
    @pulumi.getter
    def manual(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @manual.setter
    def manual(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class EtcdBackup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            manual: Optional[pulumi.Input[builtins.bool]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            namespace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EtcdBackup':
        """
    ...
    @property
    @pulumi.getter
    def manual(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Manual execution of the Etcd Backup. Default `false` (bool)
        """
        return pulumi.get(self, "manual")
