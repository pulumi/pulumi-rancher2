...
def get_certificate(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the certificate (string)
    :param builtins.str namespace_id: The namespace id where to assign the namespaced certificate (string)
    :param builtins.str project_id: The project id where to assign the certificate (string)
    """
    __args__ = dict()
    __args__['name'] = name
