...
class ClusterDriverArgs:
    def __init__(__self__, *,
                 ...
                 builtin: pulumi.Input[builtins.bool],
                 url: pulumi.Input[builtins.str],
                 actual_url: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 ui_url: Optional[pulumi.Input[builtins.str]] = None,
                 whitelist_domains: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ClusterDriver resource.
        :param pulumi.Input[builtins.bool] active: Specify the cluster driver state (bool)
        :param pulumi.Input[builtins.bool] builtin: Specify whether the cluster driver is an internal cluster driver or not (bool)
        :param pulumi.Input[builtins.str] url: The URL to download the machine driver binary for 64-bit Linux (string)
        :param pulumi.Input[builtins.str] actual_url: Actual url of the cluster driver (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations of the resource (map)
        :param pulumi.Input[builtins.str] checksum: Verify that the downloaded driver matches the expected checksum (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels of the resource (map)
        :param pulumi.Input[builtins.str] name: Name of the cluster driver (string)
        :param pulumi.Input[builtins.str] ui_url: The URL to load for customized Add Clusters screen for this driver (string)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] whitelist_domains: Domains to whitelist for the ui (list)
        """
    ...
    @property
    @pulumi.getter
    def builtin(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @builtin.setter
    def builtin(self, value: pulumi.Input[builtins.bool]):
    ...
    def actual_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @actual_url.setter
    def actual_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ui_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ui_url.setter
    def ui_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ui_url", value)

    @property
    @pulumi.getter(name="whitelistDomains")
    def whitelist_domains(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def whitelist_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ClusterDriver(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ui_url: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            whitelist_domains: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ClusterDriver':
        """
    ...
    @property
    @pulumi.getter(name="actualUrl")
    def actual_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Actual url of the cluster driver (string)
        """
        return pulumi.get(self, "actual_url")
    ...
    @property
    @pulumi.getter(name="uiUrl")
    def ui_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL to load for customized Add Clusters screen for this driver (string)
        """
        return pulumi.get(self, "ui_url")
    ...
    @property
    @pulumi.getter(name="whitelistDomains")
    def whitelist_domains(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Domains to whitelist for the ui (list)
        """
        return pulumi.get(self, "whitelist_domains")
