...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] access_key: API Key used to authenticate with the rancher server
        :param pulumi.Input[_builtins.str] api_url: The URL to the rancher API
        :param pulumi.Input[_builtins.bool] bootstrap: Bootstrap rancher server
        :param pulumi.Input[_builtins.str] ca_certs: CA certificates used to sign rancher server tls certificates. Mandatory if self signed tls and insecure option false
        :param pulumi.Input[_builtins.bool] insecure: Allow insecure connections to Rancher. Mandatory if self signed tls and not ca_certs provided
        :param pulumi.Input[_builtins.int] retries: Rancher connection retries
        :param pulumi.Input[_builtins.str] secret_key: API secret used to authenticate with the rancher server
        :param pulumi.Input[_builtins.str] timeout: Rancher connection timeout (retry every 5s). Golang duration format, ex: "60s"
        :param pulumi.Input[_builtins.str] token_key: API token used to authenticate with the rancher server
        """
...
@pulumi.type_token("pulumi:providers:rancher2")
class Provider(pulumi.ProviderResource):
    ...
    @_builtins.property
    @pulumi.getter(name="caCerts")
    def ca_certs(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        CA certificates used to sign rancher server tls certificates. Mandatory if self signed tls and insecure option false
        """
        return pulumi.get(self, "ca_certs")
    ...
    def terraform_config(__self__) -> pulumi.Output['Provider.TerraformConfigResult']:
        ...
        return pulumi.runtime.call('pulumi:providers:rancher2/terraformConfig', __args__, res=__self__, typ=Provider.TerraformConfigResult)
