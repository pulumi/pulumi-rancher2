...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] retries: Rancher connection retries
        :param pulumi.Input[builtins.str] secret_key: API secret used to authenticate with the rancher server
    ...
    def ca_certs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ca_certs.setter
    def ca_certs(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="caCerts")
    def ca_certs(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        CA certificates used to sign rancher server tls certificates. Mandatory if self signed tls and insecure option false
        """
        return pulumi.get(self, "ca_certs")
