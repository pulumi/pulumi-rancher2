...
class AuthConfigOpenLdapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] servers: OpenLdap servers list (list)
        :param pulumi.Input[builtins.str] service_account_distinguished_name: Service account DN for access OpenLdap service (string)
        :param pulumi.Input[builtins.str] service_account_password: Service account password for access OpenLdap service (string)
        :param pulumi.Input[builtins.str] test_password: Password for test access to OpenLdap service (string)
        :param pulumi.Input[builtins.str] test_username: Username for test access to OpenLdap service (string)
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_principal_ids: Allowed principal ids for auth. Required if `access_mode` is `required` or `restricted`. Ex: `openldap_user://<DN>`  `openldap_group://<DN>` (list)
        ...
        :param pulumi.Input[builtins.int] connection_timeout: OpenLdap connection timeout. Default `5000` (int)
        ...
        :param pulumi.Input[builtins.int] port: OpenLdap port. Default `389` (int)
...
class AuthConfigOpenLdap(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_search_attribute: Optional[pulumi.Input[builtins.str]] = None,
            user_search_base: Optional[pulumi.Input[builtins.str]] = None,
            user_search_filter: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthConfigOpenLdap':
        """
