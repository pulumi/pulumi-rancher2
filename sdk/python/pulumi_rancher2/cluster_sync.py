...
class ClusterSyncArgs:
    def __init__(__self__, *,
                 ...
                 node_pool_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 state_confirm: Optional[pulumi.Input[builtins.int]] = None,
                 synced: Optional[pulumi.Input[builtins.bool]] = None,
                 wait_catalogs: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ClusterSync resource.
        :param pulumi.Input[builtins.str] cluster_id: The cluster ID that is syncing (string)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] node_pool_ids: The node pool IDs used by the cluster id (list)
        :param pulumi.Input[builtins.int] state_confirm: Wait until active status is confirmed a number of times (wait interval of 5s). Default: `1` means no confirmation (int)
        ...
        :param pulumi.Input[builtins.bool] wait_catalogs: Wait until all catalogs are downloaded and active. Default: `false` (bool)
        """
    ...
    def node_pool_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def node_pool_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "node_pool_ids", value)

    @property
    @pulumi.getter(name="stateConfirm")
    def state_confirm(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def state_confirm(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "state_confirm", value)

    @property
    @pulumi.getter
    def synced(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "synced")

    @synced.setter
    def synced(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "synced", value)

    @property
    @pulumi.getter(name="waitCatalogs")
    def wait_catalogs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def wait_catalogs(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ClusterSyncState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The cluster ID that is syncing (string)
        :param pulumi.Input[builtins.str] default_project_id: (Computed) Default project ID for the cluster sync (string)
        :param pulumi.Input[builtins.str] kube_config: (Computed/Sensitive) Kube Config generated for the cluster sync (string)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] node_pool_ids: The node pool IDs used by the cluster id (list)
        :param pulumi.Input[Sequence[pulumi.Input['ClusterSyncNodeArgs']]] nodes: (Computed) The cluster nodes (list).
        :param pulumi.Input[builtins.int] state_confirm: Wait until active status is confirmed a number of times (wait interval of 5s). Default: `1` means no confirmation (int)
               
               **Note:** `state_confirm` would be useful, if you have troubles for creating/updating custom clusters that eventually are reaching `active` state before they are fully installed. For example: setting `state_confirm = 2` will assure that the cluster has been in `active` state for at least 5 seconds, `state_confirm = 3` assure at least 10 seconds, etc
        :param pulumi.Input[builtins.str] system_project_id: (Computed) System project ID for the cluster sync (string)
        :param pulumi.Input[builtins.bool] wait_catalogs: Wait until all catalogs are downloaded and active. Default: `false` (bool)
        """
...
class ClusterSync(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            synced: Optional[pulumi.Input[builtins.bool]] = None,
            system_project_id: Optional[pulumi.Input[builtins.str]] = None,
            wait_catalogs: Optional[pulumi.Input[builtins.bool]] = None) -> 'ClusterSync':
        """
    ...
    @property
    @pulumi.getter(name="nodePoolIds")
    def node_pool_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The node pool IDs used by the cluster id (list)
        """
        return pulumi.get(self, "node_pool_ids")
    ...
    @property
    @pulumi.getter(name="stateConfirm")
    def state_confirm(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Wait until active status is confirmed a number of times (wait interval of 5s). Default: `1` means no confirmation (int)
    ...
    @property
    @pulumi.getter
    def synced(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "synced")
    ...
    @property
    @pulumi.getter(name="waitCatalogs")
    def wait_catalogs(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Wait until all catalogs are downloaded and active. Default: `false` (bool)
        """
        return pulumi.get(self, "wait_catalogs")
