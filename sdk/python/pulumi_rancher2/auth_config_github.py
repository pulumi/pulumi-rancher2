...
class AuthConfigGithubArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] hostname: Github hostname to connect. Default `github.com` (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels of the resource (map)
        :param pulumi.Input[_builtins.bool] tls: Enable TLS connection. Default `true` (bool)
        """
...
class AuthConfigGithub(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            tls: Optional[pulumi.Input[_builtins.bool]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'AuthConfigGithub':
        """
