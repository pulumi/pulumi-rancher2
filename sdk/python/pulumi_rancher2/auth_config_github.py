...
class AuthConfigGithubArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_id: Github auth Client ID (string)
        :param pulumi.Input[builtins.str] client_secret: Github auth Client secret (string)
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_principal_ids: Allowed principal ids for auth. Required if `access_mode` is `required` or `restricted`. Ex: `github_user://<USER_ID>`  `github_team://<GROUP_ID>` `github_org://<ORG_ID>` (list)
        ...
        :param pulumi.Input[builtins.str] hostname: Github hostname to connect. Default `github.com` (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels of the resource (map)
        :param pulumi.Input[builtins.bool] tls: Enable TLS connection. Default `true` (bool)
        """
...
class AuthConfigGithub(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tls: Optional[pulumi.Input[builtins.bool]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthConfigGithub':
        """
    ...
    @property
    @pulumi.getter
    def tls(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable TLS connection. Default `true` (bool)
        """
        return pulumi.get(self, "tls")
