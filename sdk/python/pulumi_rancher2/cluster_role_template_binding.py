...
class ClusterRoleTemplateBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The cluster id where bind cluster role template binding (string)
        :param pulumi.Input[builtins.str] role_template_id: The role template id from create cluster role template binding (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for cluster role template binding (map)
        :param pulumi.Input[builtins.str] group_id: The group ID to assign cluster role template binding (string)
        :param pulumi.Input[builtins.str] group_principal_id: The group_principal ID to assign cluster role template binding (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for cluster role template binding (map)
               
               **Note:** user `user_id | user_principal_id` OR group `group_id | group_principal_id` must be defined
        :param pulumi.Input[builtins.str] name: The name of the cluster role template binding (string)
        :param pulumi.Input[builtins.str] user_id: The user ID to assign cluster role template binding (string)
        :param pulumi.Input[builtins.str] user_principal_id: The user_principal ID to assign cluster role template binding (string)
        """
...
class ClusterRoleTemplateBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_template_id: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None,
            user_principal_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ClusterRoleTemplateBinding':
        """
