...
class MultiClusterAppArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] catalog_name: The multi cluster app catalog name (string)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: The multi cluster app roles (list)
        :param pulumi.Input[Sequence[pulumi.Input['MultiClusterAppTargetArgs']]] targets: The multi cluster app target projects (list)
        :param pulumi.Input[builtins.str] template_name: The multi cluster app template name (string)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for multi cluster app object (map)
        :param pulumi.Input[Sequence[pulumi.Input['MultiClusterAppAnswerArgs']]] answers: The multi cluster app answers (list)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for multi cluster app object (map)
        :param pulumi.Input[Sequence[pulumi.Input['MultiClusterAppMemberArgs']]] members: The multi cluster app answers (list)
        :param pulumi.Input[builtins.str] name: The multi cluster app name (string)
        :param pulumi.Input[builtins.int] revision_history_limit: The multi cluster app revision history limit. Default `10` (int)
        :param pulumi.Input[builtins.str] revision_id: Current revision id for the multi cluster app (string)
        :param pulumi.Input[builtins.str] template_version: The multi cluster app template version. Default: `latest` (string)
        ...
        :param pulumi.Input[builtins.bool] wait: Wait until the multi cluster app is active. Default `true` (bool)
        """
...
class _MultiClusterAppState:
    def __init__(__self__, *,
                 ...
                 template_version: Optional[pulumi.Input[builtins.str]] = None,
                 template_version_id: Optional[pulumi.Input[builtins.str]] = None,
                 upgrade_strategy: Optional[pulumi.Input['MultiClusterAppUpgradeStrategyArgs']] = None,
                 wait: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] template_name: The multi cluster app template name (string)
        :param pulumi.Input[builtins.str] template_version: The multi cluster app template version. Default: `latest` (string)
        :param pulumi.Input[builtins.str] template_version_id: (Computed) The multi cluster app template version ID (string)
        :param pulumi.Input['MultiClusterAppUpgradeStrategyArgs'] upgrade_strategy: The multi cluster app upgrade strategy (list MaxItems:1)
        :param pulumi.Input[builtins.bool] wait: Wait until the multi cluster app is active. Default `true` (bool)
        """
        if annotations is not None:
    ...
    def template_version_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def template_version_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MultiClusterApp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            template_version_id: Optional[pulumi.Input[builtins.str]] = None,
            upgrade_strategy: Optional[pulumi.Input[Union['MultiClusterAppUpgradeStrategyArgs', 'MultiClusterAppUpgradeStrategyArgsDict']]] = None,
            wait: Optional[pulumi.Input[builtins.bool]] = None) -> 'MultiClusterApp':
        """
    ...
    @property
    @pulumi.getter(name="revisionHistoryLimit")
    def revision_history_limit(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The multi cluster app revision history limit. Default `10` (int)
        """
        return pulumi.get(self, "revision_history_limit")
    ...
    @property
    @pulumi.getter(name="templateVersionId")
    def template_version_id(self) -> pulumi.Output[builtins.str]:
        """
        (Computed) The multi cluster app template version ID (string)
        """
        return pulumi.get(self, "template_version_id")
