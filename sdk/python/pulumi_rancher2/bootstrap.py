...
class BootstrapArgs:
    ...
    def initial_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def initial_password(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def token_update(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @token_update.setter
    def token_update(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "token_update", value)

    @property
    @pulumi.getter(name="uiDefaultLanding")
    def ui_default_landing(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ui_default_landing(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BootstrapState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] token_id: (Computed) Generated API token id for Admin User (string)
        :param pulumi.Input[builtins.int] token_ttl: TTL in seconds for generated admin token. Default: `0`  (int)
        :param pulumi.Input[builtins.bool] token_update: Regenerate admin token. Default: `false` (bool)
        :param pulumi.Input[builtins.str] ui_default_landing: Default UI landing for k8s clusters. Available options: `ember` (cluster manager ui)  and `vue` (cluster explorer ui). Default: `ember` (string)
        :param pulumi.Input[builtins.str] url: (Computed) URL set as server-url (string)
        :param pulumi.Input[builtins.str] user: (Computed) Admin username (string)
        """
    ...
    def current_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_password(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Bootstrap(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ui_default_landing: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            user: Optional[pulumi.Input[builtins.str]] = None) -> 'Bootstrap':
        """
    ...
    @property
    @pulumi.getter(name="currentPassword")
    def current_password(self) -> pulumi.Output[builtins.str]:
        """
        (Computed/Sensitive) Current password for Admin user (string)
        """
        return pulumi.get(self, "current_password")
    ...
    @property
    @pulumi.getter(name="initialPassword")
    def initial_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Initial password for Admin user. Default: `admin` (string)
        """
        return pulumi.get(self, "initial_password")
    ...
    @property
    @pulumi.getter(name="tokenUpdate")
    def token_update(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Regenerate admin token. Default: `false` (bool)
        """
        return pulumi.get(self, "token_update")
    ...
    @property
    @pulumi.getter(name="uiDefaultLanding")
    def ui_default_landing(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Default UI landing for k8s clusters. Available options: `ember` (cluster manager ui)  and `vue` (cluster explorer ui). Default: `ember` (string)
        """
        return pulumi.get(self, "ui_default_landing")
