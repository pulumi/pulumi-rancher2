...
class GetNodePoolResult:
    ...
    def control_plane(self) -> _builtins.bool:
        """
    ...
    def delete_not_ready_after_secs(self) -> _builtins.int:
        """
    ...
    def node_template_id(self) -> _builtins.str:
    ...
    @_builtins.property
    @pulumi.getter
    def worker(self) -> _builtins.bool:
        """
...
def get_node_pool(cluster_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cluster_id: The RKE cluster id to use Node Pool (string)
    :param _builtins.str name: The name of the Node Pool (string)
    :param _builtins.str node_template_id: The Node Template ID to use for node creation (string)
    """
    __args__ = dict()
