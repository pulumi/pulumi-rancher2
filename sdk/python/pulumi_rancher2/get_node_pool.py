...
class GetNodePoolResult:
    ...
    def control_plane(self) -> builtins.bool:
        """
    ...
    def delete_not_ready_after_secs(self) -> builtins.int:
        """
    ...
    def node_template_id(self) -> builtins.str:
...
def get_node_pool(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: The RKE cluster id to use Node Pool (string)
    :param builtins.str name: The name of the Node Pool (string)
    :param builtins.str node_template_id: The Node Template ID to use for node creation (string)
    """
    __args__ = dict()
...
def get_node_pool_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                         name: Optional[pulumi.Input[builtins.str]] = None,
                         node_template_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
