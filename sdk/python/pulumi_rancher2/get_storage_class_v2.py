...
class GetStorageClassV2Result:
    ...
    def allow_volume_expansion(self) -> builtins.bool:
        """
    ...
    def k8s_provisioner(self) -> builtins.str:
        """
...
def get_storage_class_v2(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: The cluster id of the storageClass V2 (string)
    :param builtins.str name: The name of the storageClass v2 (string)
    """
    __args__ = dict()
...
def get_storage_class_v2_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
