...
class GetStorageClassV2Result:
    ...
    def k8s_provisioner(self) -> _builtins.str:
        """
...
def get_storage_class_v2(cluster_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cluster_id: The cluster id of the storageClass V2 (string)
    :param _builtins.str name: The name of the storageClass v2 (string)
    """
    __args__ = dict()
