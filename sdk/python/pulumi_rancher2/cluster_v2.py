...
class ClusterV2Args:
    def __init__(__self__, *,
                 ...
                 cloud_credential_secret_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 default_cluster_role_for_project_members: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 fleet_namespace: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] kubernetes_version: The RKE2 or K3s version for the cluster.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations for the Cluster.
        :param pulumi.Input[builtins.str] cloud_credential_secret_name: Cloud credential secret name is the secret to be used when a cloud credential secret name is not specified at the machine pool level.
        ...
        :param pulumi.Input[builtins.str] default_cluster_role_for_project_members: Default cluster role for project members.
        :param pulumi.Input[builtins.str] default_pod_security_admission_configuration_template_name: The name of the pre-defined pod security admission configuration template to be applied to the cluster. Rancher admins (or those with the right permissions) can create, manage, and edit those templates. For more information, please refer to [Rancher Documentation](https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/psa-config-templates). The argument is available in Rancher v2.7.2 and above.
        :param pulumi.Input[builtins.bool] enable_network_policy: Enable k8s network policy on the cluster.
        ...
        :param pulumi.Input[builtins.str] fleet_namespace: Fleet namespace is the namespace where the cluster is to create in the local cluster. It is recommended to leave it as the default value.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the Cluster.
    ...
    def cloud_credential_secret_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cloud_credential_secret_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def default_cluster_role_for_project_members(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_cluster_role_for_project_members(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def fleet_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fleet_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClusterV2State:
    def __init__(__self__, *,
                 ...
                 cluster_v1_id: Optional[pulumi.Input[builtins.str]] = None,
                 default_cluster_role_for_project_members: Optional[pulumi.Input[builtins.str]] = None,
                 default_pod_security_admission_configuration_template_name: Optional[pulumi.Input[builtins.str]] = None,
                 enable_network_policy: Optional[pulumi.Input[builtins.bool]] = None,
                 fleet_agent_deployment_customizations: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV2FleetAgentDeploymentCustomizationArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_v1_id: (Computed, string) Cluster v1 id for cluster v2. (e.g. to be used with `rancher2_sync`).
        :param pulumi.Input[builtins.str] default_cluster_role_for_project_members: Default cluster role for project members.
        :param pulumi.Input[builtins.str] default_pod_security_admission_configuration_template_name: The name of the pre-defined pod security admission configuration template to be applied to the cluster. Rancher admins (or those with the right permissions) can create, manage, and edit those templates. For more information, please refer to [Rancher Documentation](https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/psa-config-templates). The argument is available in Rancher v2.7.2 and above.
        :param pulumi.Input[builtins.bool] enable_network_policy: Enable k8s network policy on the cluster.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterV2FleetAgentDeploymentCustomizationArgs']]] fleet_agent_deployment_customizations: Fleet agent deployment customization specifies the additional tolerations, new affinity rules, and new resource requirements on the `fleet-agent` deployment. The argument is available in Rancher v2.7.5 and above.
        :param pulumi.Input[builtins.str] fleet_namespace: Fleet namespace is the namespace where the cluster is to create in the local cluster. It is recommended to leave it as the default value.
        :param pulumi.Input[builtins.str] kube_config: (Computed/Sensitive) Kube Config generated for the cluster. Note: When the cluster has `local_auth_endpoint` enabled, the kube_config will not be available until the cluster is `connected`.
        :param pulumi.Input[builtins.str] kubernetes_version: The RKE2 or K3s version for the cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for the Cluster.
        :param pulumi.Input['ClusterV2LocalAuthEndpointArgs'] local_auth_endpoint: Local auth endpoint configures the Authorized Cluster Endpoint (ACE) which can be used to directly access the Kubernetes API server, without requiring communication through Rancher. For more information, please refer to [Rancher Documentation](https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/register-existing-clusters#authorized-cluster-endpoint-support-for-rke2-and-k3s-clusters).
        :param pulumi.Input[builtins.str] name: The name of the cluster.
        :param pulumi.Input[builtins.str] resource_version: (Computed, string) Cluster's k8s resource version.
        :param pulumi.Input['ClusterV2RkeConfigArgs'] rke_config: The RKE configuration for the cluster.
        """
        if agent_env_vars is not None:
            pulumi.set(__self__, "agent_env_vars", agent_env_vars)
    ...
    def cluster_v1_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_v1_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterV2(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="cloudCredentialSecretName")
    def cloud_credential_secret_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cloud credential secret name is the secret to be used when a cloud credential secret name is not specified at the machine pool level.
        """
        return pulumi.get(self, "cloud_credential_secret_name")
    ...
    @property
    @pulumi.getter(name="clusterV1Id")
    def cluster_v1_id(self) -> pulumi.Output[builtins.str]:
        """
        (Computed, string) Cluster v1 id for cluster v2. (e.g. to be used with `rancher2_sync`).
        """
        return pulumi.get(self, "cluster_v1_id")
    ...
    @property
    @pulumi.getter(name="defaultClusterRoleForProjectMembers")
    def default_cluster_role_for_project_members(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Default cluster role for project members.
        """
        return pulumi.get(self, "default_cluster_role_for_project_members")
    ...
    @property
    @pulumi.getter(name="defaultPodSecurityAdmissionConfigurationTemplateName")
    def default_pod_security_admission_configuration_template_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the pre-defined pod security admission configuration template to be applied to the cluster. Rancher admins (or those with the right permissions) can create, manage, and edit those templates. For more information, please refer to [Rancher Documentation](https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/psa-config-templates). The argument is available in Rancher v2.7.2 and above.
        """
        return pulumi.get(self, "default_pod_security_admission_configuration_template_name")
    ...
    @property
    @pulumi.getter(name="fleetNamespace")
    def fleet_namespace(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Fleet namespace is the namespace where the cluster is to create in the local cluster. It is recommended to leave it as the default value.
        """
        return pulumi.get(self, "fleet_namespace")
