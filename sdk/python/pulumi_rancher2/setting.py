...
class SettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] annotations: Annotations for setting object (map)
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] labels: Labels for setting object (map)
