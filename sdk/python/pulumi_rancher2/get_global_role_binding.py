...
class GetGlobalRoleBindingResult:
    ...
    def global_role_id(self) -> builtins.str:
...
def get_global_role_binding(global_role_id: Optional[builtins.str] = None,
    ...
    :param builtins.str global_role_id: The global role id (string)
    :param builtins.str name: The name of the global role binding (string)
    """
    __args__ = dict()
...
def get_global_role_binding_output(global_role_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
