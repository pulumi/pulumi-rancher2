...
def get_catalog(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The catalog name.
    :param builtins.str scope: The scope of the catalog. `cluster`, `global`, and `project` are supported. Default `global` (string)
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_catalog_output(name: Optional[pulumi.Input[builtins.str]] = None,
