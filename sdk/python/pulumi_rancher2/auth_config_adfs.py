...
class AuthConfigAdfsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] sp_cert: ADFS SP cert (string)
        :param pulumi.Input[_builtins.str] sp_key: ADFS SP key (string)
        :param pulumi.Input[_builtins.str] uid_field: ADFS UID field (string)
        :param pulumi.Input[_builtins.str] user_name_field: ADFS user name field (string)
