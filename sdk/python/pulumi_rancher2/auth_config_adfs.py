...
class AuthConfigAdfsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] allowed_principal_ids: Allowed principal ids for auth. Required if `access_mode` is `required` or `restricted`. Ex: `adfs_user://<USER_ID>`  `adfs_group://<GROUP_ID>` (list)
...
class _AuthConfigAdfsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] user_name_field: ADFS user name field (string)
        """
        _AuthConfigAdfsState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            access_mode=access_mode,
            allowed_principal_ids=allowed_principal_ids,
            annotations=annotations,
...
class AuthConfigAdfs(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AuthConfigAdfsArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[str]] = None,
            uid_field: Optional[pulumi.Input[str]] = None,
            user_name_field: Optional[pulumi.Input[str]] = None) -> 'AuthConfigAdfs':
        """
