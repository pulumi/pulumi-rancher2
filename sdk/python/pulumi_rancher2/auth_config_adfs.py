...
__all__ = ['AuthConfigAdfsArgs', 'AuthConfigAdfs']

@pulumi.input_type
class AuthConfigAdfsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name_field: ADFS display name field (string)
        :param pulumi.Input[builtins.str] groups_field: ADFS group field (string)
        :param pulumi.Input[builtins.str] idp_metadata_content: ADFS IDP metadata content (string)
        ...
        :param pulumi.Input[builtins.str] sp_cert: ADFS SP cert (string)
        :param pulumi.Input[builtins.str] sp_key: ADFS SP key (string)
        :param pulumi.Input[builtins.str] uid_field: ADFS UID field (string)
        :param pulumi.Input[builtins.str] user_name_field: ADFS user name field (string)
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_principal_ids: Allowed principal ids for auth. Required if `access_mode` is `required` or `restricted`. Ex: `adfs_user://<USER_ID>`  `adfs_group://<GROUP_ID>` (list)
...
class AuthConfigAdfs(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AuthConfigAdfsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AuthConfigAdfsArgs.__new__(AuthConfigAdfsArgs)
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            uid_field: Optional[pulumi.Input[builtins.str]] = None,
            user_name_field: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthConfigAdfs':
        """
        ...
        __props__ = _AuthConfigAdfsState.__new__(_AuthConfigAdfsState)
