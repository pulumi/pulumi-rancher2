...
class AwaitableGetPrincipalResult(GetPrincipalResult):
...
def get_principal(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The full name of the principal (string)
    :param builtins.str type: The type of the identity (string). Defaults to `user`. Only `user` and `group` values are supported (string)
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['type'] = type
...
def get_principal_output(name: Optional[pulumi.Input[builtins.str]] = None,
