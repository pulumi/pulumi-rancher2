...
class FeatureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] value: The value of the feature. Default: `false` (bool)
        """
...
class Feature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            value: Optional[pulumi.Input[_builtins.bool]] = None) -> 'Feature':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def value(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        The value of the feature. Default: `false` (bool)
        """
        return pulumi.get(self, "value")
