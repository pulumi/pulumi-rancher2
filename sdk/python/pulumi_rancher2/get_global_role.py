...
class GetGlobalRoleResult:
    ...
    def inherited_cluster_roles(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def new_user_default(self) -> builtins.bool:
        """
...
def get_global_role(inherited_cluster_roles: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] inherited_cluster_roles: (Optional) Names of role templates whose permissions are granted by this global role in every cluster besides the local cluster (list)
    :param builtins.str name: The name of the Global Role (string)
    """
    __args__ = dict()
