...
namespace Pulumi.Rancher2
{
    public static class GetNodeDriver
    {
        ...
        /// {
        ///     var foo = Rancher2.Index.GetNodeDriver.Invoke(new()
        ///     {
        ///         Name = "foo",
        ///     });
        /// 
        ...
        /// ```
        /// </summary>
        public static Output<GetNodeDriverResult> Invoke(GetNodeDriverInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetNodeDriverResult>("rancher2:index/getNodeDriver:getNodeDriver", args ?? new GetNodeDriverInvokeArgs(), options.WithDefaults());
    }
