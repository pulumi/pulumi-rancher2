...
{
    [Rancher2ResourceType("rancher2:index/authConfigKeycloakOidc:AuthConfigKeycloakOidc")]
    public partial class AuthConfigKeycloakOidc : global::Pulumi.CustomResource
    {
        [Output("accessMode")]
        ...
        public AuthConfigKeycloakOidc(string name, AuthConfigKeycloakOidcArgs args, CustomResourceOptions? options = null)
            : base("rancher2:index/authConfigKeycloakOidc:AuthConfigKeycloakOidc", name, args ?? new AuthConfigKeycloakOidcArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthConfigKeycloakOidc(string name, Input<string> id, AuthConfigKeycloakOidcState? state = null, CustomResourceOptions? options = null)
            : base("rancher2:index/authConfigKeycloakOidc:AuthConfigKeycloakOidc", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AuthConfigKeycloakOidc Get(string name, Input<string> id, AuthConfigKeycloakOidcState? state = null, CustomResourceOptions? options = null)
        {
            return new AuthConfigKeycloakOidc(name, id, state, options);
        }
    }

    public sealed class AuthConfigKeycloakOidcArgs : global::Pulumi.ResourceArgs
    {
        [Input("accessMode")]
        ...
        public AuthConfigKeycloakOidcArgs()
        {
        }
        public static new AuthConfigKeycloakOidcArgs Empty => new AuthConfigKeycloakOidcArgs();
    }

    public sealed class AuthConfigKeycloakOidcState : global::Pulumi.ResourceArgs
    {
        [Input("accessMode")]
        public Input<string>? AccessMode { get; set; }
        ...
        public AuthConfigKeycloakOidcState()
        {
        }
        public static new AuthConfigKeycloakOidcState Empty => new AuthConfigKeycloakOidcState();
    }
}
