...
namespace Pulumi.Rancher2
{
    ...
    public partial class AuthConfigFreeIpa : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public AuthConfigFreeIpa(string name, AuthConfigFreeIpaArgs args, CustomResourceOptions? options = null)
            : base("rancher2:index/authConfigFreeIpa:AuthConfigFreeIpa", name, args ?? new AuthConfigFreeIpaArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class AuthConfigFreeIpaArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Access mode for auth. `required`, `restricted`, `unrestricted` are supported. Default `unrestricted` (string)
        /// </summary>
        ...
        public static new AuthConfigFreeIpaArgs Empty => new AuthConfigFreeIpaArgs();
    }

    public sealed class AuthConfigFreeIpaState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Access mode for auth. `required`, `restricted`, `unrestricted` are supported. Default `unrestricted` (string)
        /// </summary>
        ...
        public static new AuthConfigFreeIpaState Empty => new AuthConfigFreeIpaState();
    }
}
