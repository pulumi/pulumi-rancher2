...
public final class EtcdBackupArgs extends com.pulumi.resources.ResourceArgs {

    public static final EtcdBackupArgs Empty = new EtcdBackupArgs();
    ...
    private EtcdBackupArgs() {}

    private EtcdBackupArgs(EtcdBackupArgs $) {
    ...
    public static Builder builder(EtcdBackupArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EtcdBackupArgs defaults) {
            $ = new EtcdBackupArgs(Objects.requireNonNull(defaults));
        }
