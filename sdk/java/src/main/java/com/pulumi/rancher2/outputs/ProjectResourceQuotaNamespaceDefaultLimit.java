...
public final class ProjectResourceQuotaNamespaceDefaultLimit {
    ...
    public static final class Builder {
        ...
        public Builder servicesNodePorts(@Nullable String servicesNodePorts) {
            ...
            return new ProjectResourceQuotaNamespaceDefaultLimit(configMaps, limitsCpu, limitsMemory, persistentVolumeClaims, pods, replicationControllers, requestsCpu, requestsMemory, requestsStorage, secrets, services, servicesLoadBalancers, servicesNodePorts);
        }
    }
}
