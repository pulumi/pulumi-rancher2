...
@CustomType
public final class GetClusterRkeConfigUpgradeStrategyDrainInput {
    ...
    private GetClusterRkeConfigUpgradeStrategyDrainInput(
    ...
    public static Builder builder(GetClusterRkeConfigUpgradeStrategyDrainInput defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetClusterRkeConfigUpgradeStrategyDrainInput defaults) {
        ...
        public Builder timeout(@Nullable Integer timeout) {
            this.timeout = timeout;
            return this;
        }        public GetClusterRkeConfigUpgradeStrategyDrainInput build() {
            return new GetClusterRkeConfigUpgradeStrategyDrainInput(deleteLocalData, force, gracePeriod, ignoreDaemonSets, timeout);
        }
    }
}
