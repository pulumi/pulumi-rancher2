...
public final class ClusterAlertRuleMetricRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterAlertRuleMetricRuleArgs Empty = new ClusterAlertRuleMetricRuleArgs();
    ...
    private ClusterAlertRuleMetricRuleArgs() {}

    private ClusterAlertRuleMetricRuleArgs(ClusterAlertRuleMetricRuleArgs $) {
    ...
    public static Builder builder(ClusterAlertRuleMetricRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterAlertRuleMetricRuleArgs();
        }

        public Builder(ClusterAlertRuleMetricRuleArgs defaults) {
            $ = new ClusterAlertRuleMetricRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterAlertRuleMetricRuleArgs build() {
            if ($.duration == null) {
                throw new MissingRequiredPropertyException("ClusterAlertRuleMetricRuleArgs", "duration");
            }
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("ClusterAlertRuleMetricRuleArgs", "expression");
            }
            if ($.thresholdValue == null) {
                throw new MissingRequiredPropertyException("ClusterAlertRuleMetricRuleArgs", "thresholdValue");
            }
            return $;
        }
    }
