...
@CustomType
public final class GlobalRoleInheritedNamespacedRuleRule {
    /**
    ...
    private GlobalRoleInheritedNamespacedRuleRule() {}
    /**
     * @return Policy rule api groups
     * 
     */
    ...
    public static Builder builder(GlobalRoleInheritedNamespacedRuleRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> verbs;
        public Builder() {}
        public Builder(GlobalRoleInheritedNamespacedRuleRule defaults) {
        ...
        public GlobalRoleInheritedNamespacedRuleRule build() {
            final var _resultValue = new GlobalRoleInheritedNamespacedRuleRule();
