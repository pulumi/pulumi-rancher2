...
public final class AuthConfigOpenLdapArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthConfigOpenLdapArgs Empty = new AuthConfigOpenLdapArgs();
    ...
    private AuthConfigOpenLdapArgs() {}

    private AuthConfigOpenLdapArgs(AuthConfigOpenLdapArgs $) {
    ...
    public static Builder builder(AuthConfigOpenLdapArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthConfigOpenLdapArgs();
        }

        public Builder(AuthConfigOpenLdapArgs defaults) {
            $ = new AuthConfigOpenLdapArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param connectionTimeout OpenLdap connection timeout. Default `5000` (int)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param port OpenLdap port. Default `389` (int)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param servers OpenLdap servers list (list)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serviceAccountDistinguishedName Service account DN for access OpenLdap service (string)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serviceAccountPassword Service account password for access OpenLdap service (string)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param testPassword Password for test access to OpenLdap service (string)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param testUsername Username for test access to OpenLdap service (string)
         * 
         * @return builder
         * 
         */
        ...
        public AuthConfigOpenLdapArgs build() {
            if ($.servers == null) {
                throw new MissingRequiredPropertyException("AuthConfigOpenLdapArgs", "servers");
            }
            if ($.serviceAccountDistinguishedName == null) {
                throw new MissingRequiredPropertyException("AuthConfigOpenLdapArgs", "serviceAccountDistinguishedName");
            }
            if ($.serviceAccountPassword == null) {
                throw new MissingRequiredPropertyException("AuthConfigOpenLdapArgs", "serviceAccountPassword");
            }
            if ($.testPassword == null) {
                throw new MissingRequiredPropertyException("AuthConfigOpenLdapArgs", "testPassword");
            }
            if ($.testUsername == null) {
                throw new MissingRequiredPropertyException("AuthConfigOpenLdapArgs", "testUsername");
            }
            if ($.userSearchBase == null) {
                throw new MissingRequiredPropertyException("AuthConfigOpenLdapArgs", "userSearchBase");
            }
            return $;
        }
    }
