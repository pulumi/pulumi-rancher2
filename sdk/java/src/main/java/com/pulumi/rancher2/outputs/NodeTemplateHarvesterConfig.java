...
public final class NodeTemplateHarvesterConfig {
    ...
    public static final class Builder {
        ...
        public Builder sshUser(String sshUser) {
            if (sshUser == null) {
              throw new MissingRequiredPropertyException("NodeTemplateHarvesterConfig", "sshUser");
            }
        ...
        public Builder vmNamespace(String vmNamespace) {
            if (vmNamespace == null) {
              throw new MissingRequiredPropertyException("NodeTemplateHarvesterConfig", "vmNamespace");
            }
