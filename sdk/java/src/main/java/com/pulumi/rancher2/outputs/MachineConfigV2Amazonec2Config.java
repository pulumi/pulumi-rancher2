...
public final class MachineConfigV2Amazonec2Config {
    ...
    public static final class Builder {
        ...
        public Builder zone(String zone) {
            ...
            return new MachineConfigV2Amazonec2Config(accessKey, ami, blockDurationMinutes, deviceName, encryptEbsVolume, endpoint, httpEndpoint, httpTokens, iamInstanceProfile, insecureTransport, instanceType, keypairName, kmsKey, monitoring, openPorts, privateAddressOnly, region, requestSpotInstance, retries, rootSize, secretKey, securityGroupReadonly, securityGroups, sessionToken, spotPrice, sshKeyContents, sshUser, subnetId, tags, useEbsOptimizedInstance, usePrivateAddress, userdata, volumeType, vpcId, zone);
        }
    }
}
