...
public final class MultiClusterAppState extends com.pulumi.resources.ResourceArgs {

    public static final MultiClusterAppState Empty = new MultiClusterAppState();
     ...
     */
    @Import(name="targets")
    private @Nullable Output<List<MultiClusterAppTargetArgs>> targets;

    /**
     * @return The multi cluster app target projects (list)
     * 
     */
    public Optional<Output<List<MultiClusterAppTargetArgs>>> targets() {
     ...
     * 
     */
    @Import(name="templateVersionId")
    private @Nullable Output<String> templateVersionId;

    /**
     * @return (Computed) The multi cluster app template version ID (string)
     * 
     */
    public Optional<Output<String>> templateVersionId() {
        return Optional.ofNullable(this.templateVersionId);
    }
    ...
    private MultiClusterAppState() {}

    private MultiClusterAppState(MultiClusterAppState $) {
    ...
    public static Builder builder(MultiClusterAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MultiClusterAppState();
        }

        public Builder(MultiClusterAppState defaults) {
            $ = new MultiClusterAppState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder targets(@Nullable Output<List<MultiClusterAppTargetArgs>> targets) {
            $.targets = targets;
            return this;
        }
        ...
        /**
         * @param templateVersionId (Computed) The multi cluster app template version ID (string)
         * 
         * @return builder
         * 
         */
        public Builder templateVersionId(@Nullable Output<String> templateVersionId) {
        ...
        public Builder templateVersionId(String templateVersionId) {
            return templateVersionId(Output.of(templateVersionId));
        }
        ...
        public MultiClusterAppState build() {
            return $;
        }
    }
