...
import com.pulumi.rancher2.ActiveDirectoryArgs;
import com.pulumi.rancher2.Utilities;
import com.pulumi.rancher2.inputs.ActiveDirectoryState;
 ...
 * 
 * @deprecated
 * rancher2.ActiveDirectory has been deprecated in favor of rancher2.AuthConfigActiveDirectory
 * 
 */
@Deprecated /* rancher2.ActiveDirectory has been deprecated in favor of rancher2.AuthConfigActiveDirectory */
@ResourceType(type="rancher2:index/activeDirectory:ActiveDirectory")
public class ActiveDirectory extends com.pulumi.resources.CustomResource {
     ...
     */
    public ActiveDirectory(String name) {
     ...
     */
    public ActiveDirectory(String name, ActiveDirectoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rancher2:index/activeDirectory:ActiveDirectory", name, args == null ? ActiveDirectoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ActiveDirectory(String name, Output<String> id, @Nullable ActiveDirectoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rancher2:index/activeDirectory:ActiveDirectory", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static ActiveDirectory get(String name, Output<String> id, @Nullable ActiveDirectoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
