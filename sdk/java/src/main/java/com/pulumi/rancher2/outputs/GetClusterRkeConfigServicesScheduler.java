...
public final class GetClusterRkeConfigServicesScheduler {
    ...
    public static Builder builder(GetClusterRkeConfigServicesScheduler defaults) {
    ...
    public static final class Builder {
        ...
        private String image;
        public Builder() {}
        public Builder(GetClusterRkeConfigServicesScheduler defaults) {
        ...
        public Builder extraArgs(Map<String,String> extraArgs) {
            if (extraArgs == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesScheduler", "extraArgs");
            }
        ...
        public Builder image(String image) {
            if (image == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesScheduler", "image");
            }
            this.image = image;
            return this;
        }
        public GetClusterRkeConfigServicesScheduler build() {
            final var _resultValue = new GetClusterRkeConfigServicesScheduler();
