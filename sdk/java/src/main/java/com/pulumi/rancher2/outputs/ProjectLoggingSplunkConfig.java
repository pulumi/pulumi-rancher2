...
@CustomType
public final class ProjectLoggingSplunkConfig {
    /**
    ...
    public static Builder builder(ProjectLoggingSplunkConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ProjectLoggingSplunkConfig defaults) {
        ...
        public Builder token(String token) {
            ...
            return this;
        }        public ProjectLoggingSplunkConfig build() {
            return new ProjectLoggingSplunkConfig(certificate, clientCert, clientKey, clientKeyPass, endpoint, index, source, sslVerify, token);
        }
    }
}
