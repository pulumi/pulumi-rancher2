...
public final class AuthConfigAdfsState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param allowedPrincipalIds Allowed principal ids for auth. Required if `accessMode` is `required` or `restricted`. Ex: `adfs_user://&lt;USER_ID&gt;`  `adfs_group://&lt;GROUP_ID&gt;` (list)
         * 
         * @return builder
         * 
         */
