...
public final class GetClusterTemplateTemplateRevisionClusterConfigRkeConfigMonitoringToleration {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetClusterTemplateTemplateRevisionClusterConfigRkeConfigMonitoringToleration", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder seconds(Integer seconds) {
            if (seconds == null) {
              throw new MissingRequiredPropertyException("GetClusterTemplateTemplateRevisionClusterConfigRkeConfigMonitoringToleration", "seconds");
            }
        ...
        public GetClusterTemplateTemplateRevisionClusterConfigRkeConfigMonitoringToleration build() {
            final var _resultValue = new GetClusterTemplateTemplateRevisionClusterConfigRkeConfigMonitoringToleration();
