...
@CustomType
public final class GetClusterLoggingElasticsearchConfig {
    ...
    private GetClusterLoggingElasticsearchConfig(
    ...
    public static Builder builder(GetClusterLoggingElasticsearchConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetClusterLoggingElasticsearchConfig defaults) {
        ...
        public Builder sslVersion(@Nullable String sslVersion) {
            this.sslVersion = sslVersion;
            return this;
        }        public GetClusterLoggingElasticsearchConfig build() {
            return new GetClusterLoggingElasticsearchConfig(authPassword, authUsername, certificate, clientCert, clientKey, clientKeyPass, dateFormat, endpoint, indexPrefix, sslVerify, sslVersion);
        }
    }
}
