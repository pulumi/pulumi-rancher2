...
public final class ClusterTemplateTemplateRevisionClusterConfigRkeConfigNode {
    ...
    public static final class Builder {
        ...
        public Builder user(String user) {
            ...
            return new ClusterTemplateTemplateRevisionClusterConfigRkeConfigNode(address, dockerSocket, hostnameOverride, internalAddress, labels, nodeId, port, roles, sshAgentAuth, sshKey, sshKeyPath, user);
        }
    }
}
