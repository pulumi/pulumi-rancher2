...
@CustomType
public final class PodSecurityAdmissionConfigurationTemplateExemptions {
    /**
    ...
    private PodSecurityAdmissionConfigurationTemplateExemptions() {}
    /**
     * @return Pod Security Admission Configuration namespace exemptions
     * 
     */
    ...
    public static Builder builder(PodSecurityAdmissionConfigurationTemplateExemptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> usernames;
        public Builder() {}
        public Builder(PodSecurityAdmissionConfigurationTemplateExemptions defaults) {
        ...
        public PodSecurityAdmissionConfigurationTemplateExemptions build() {
            final var _resultValue = new PodSecurityAdmissionConfigurationTemplateExemptions();
