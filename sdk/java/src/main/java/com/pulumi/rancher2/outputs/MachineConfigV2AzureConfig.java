...
public final class MachineConfigV2AzureConfig {
    ...
    public static final class Builder {
        ...
        public Builder vnet(@Nullable String vnet) {
            ...
            return new MachineConfigV2AzureConfig(availabilitySet, clientId, clientSecret, customData, diskSize, dns, dockerPort, environment, faultDomainCount, image, location, managedDisks, noPublicIp, nsg, openPorts, privateIpAddress, resourceGroup, size, sshUser, staticPublicIp, storageType, subnet, subnetPrefix, subscriptionId, tenantId, updateDomainCount, usePrivateIp, vnet);
        }
    }
}
