...
public final class NodePoolNodeTaintArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private NodePoolNodeTaintArgs() {}

    private NodePoolNodeTaintArgs(NodePoolNodeTaintArgs $) {
        this.effect = $.effect;
        this.key = $.key;
    ...
    public static Builder builder(NodePoolNodeTaintArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NodePoolNodeTaintArgs();
        }

        public Builder(NodePoolNodeTaintArgs defaults) {
        ...
        public NodePoolNodeTaintArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("NodePoolNodeTaintArgs", "key");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("NodePoolNodeTaintArgs", "value");
            }
            return $;
        }
    }
