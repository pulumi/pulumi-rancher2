...
public final class ClusterV2ClusterRegistrationToken {
    ...
    public static final class Builder {
        ...
        public Builder windowsNodeCommand(@Nullable String windowsNodeCommand) {
            ...
            return new ClusterV2ClusterRegistrationToken(annotations, clusterId, command, id, insecureCommand, insecureNodeCommand, insecureWindowsNodeCommand, labels, manifestUrl, name, nodeCommand, token, windowsNodeCommand);
        }
    }
}
