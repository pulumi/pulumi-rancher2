...
public final class AuthConfigKeycloakState extends com.pulumi.resources.ResourceArgs {

    public static final AuthConfigKeycloakState Empty = new AuthConfigKeycloakState();
    ...
    /**
     * @return Allowed principal ids for auth. Required if `accessMode` is `required` or `restricted`. Ex: `keycloak_user://&lt;USER_ID&gt;`  `keycloak_group://&lt;GROUP_ID&gt;` (list)
     * 
     */
    ...
    private AuthConfigKeycloakState() {}

    private AuthConfigKeycloakState(AuthConfigKeycloakState $) {
    ...
    public static Builder builder(AuthConfigKeycloakState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthConfigKeycloakState();
        }

        public Builder(AuthConfigKeycloakState defaults) {
            $ = new AuthConfigKeycloakState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param allowedPrincipalIds Allowed principal ids for auth. Required if `accessMode` is `required` or `restricted`. Ex: `keycloak_user://&lt;USER_ID&gt;`  `keycloak_group://&lt;GROUP_ID&gt;` (list)
         * 
         * @return builder
         * 
         */
        ...
        public AuthConfigKeycloakState build() {
            return $;
        }
    }
