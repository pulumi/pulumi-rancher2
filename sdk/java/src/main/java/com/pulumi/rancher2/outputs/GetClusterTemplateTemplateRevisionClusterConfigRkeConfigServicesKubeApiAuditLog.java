    ...
    public static final class Builder {
        ...
        public Builder configuration(GetClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeApiAuditLogConfiguration configuration) {
            if (configuration == null) {
              throw new MissingRequiredPropertyException("GetClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeApiAuditLog", "configuration");
            }
        ...
        public GetClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeApiAuditLog build() {
            final var _resultValue = new GetClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeApiAuditLog();
