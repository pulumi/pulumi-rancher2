...
public final class PodSecurityPolicyTemplateFsGroupRangeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PodSecurityPolicyTemplateFsGroupRangeArgs build() {
            if ($.max == null) {
                throw new MissingRequiredPropertyException("PodSecurityPolicyTemplateFsGroupRangeArgs", "max");
            }
            if ($.min == null) {
                throw new MissingRequiredPropertyException("PodSecurityPolicyTemplateFsGroupRangeArgs", "min");
            }
            return $;
        }
    }
