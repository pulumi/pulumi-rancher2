...
public final class GetEtcdBackupBackupConfigS3BackupConfig {
    ...
    public static final class Builder {
        ...
        public Builder bucketName(String bucketName) {
            if (bucketName == null) {
              throw new MissingRequiredPropertyException("GetEtcdBackupBackupConfigS3BackupConfig", "bucketName");
            }
        ...
        public Builder endpoint(String endpoint) {
            if (endpoint == null) {
              throw new MissingRequiredPropertyException("GetEtcdBackupBackupConfigS3BackupConfig", "endpoint");
            }
        ...
        public GetEtcdBackupBackupConfigS3BackupConfig build() {
            final var _resultValue = new GetEtcdBackupBackupConfigS3BackupConfig();
