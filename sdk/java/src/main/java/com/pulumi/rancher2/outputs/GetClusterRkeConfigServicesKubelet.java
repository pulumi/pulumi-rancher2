    ...
    public static final class Builder {
        ...
        public Builder clusterDnsServer(String clusterDnsServer) {
            if (clusterDnsServer == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesKubelet", "clusterDnsServer");
            }
        ...
        public Builder clusterDomain(String clusterDomain) {
            if (clusterDomain == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesKubelet", "clusterDomain");
            }
        ...
        public Builder extraArgs(Map<String,String> extraArgs) {
            if (extraArgs == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesKubelet", "extraArgs");
            }
        ...
        public Builder failSwapOn(Boolean failSwapOn) {
            if (failSwapOn == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesKubelet", "failSwapOn");
            }
        ...
        public Builder image(String image) {
            if (image == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesKubelet", "image");
            }
            this.image = image;
            return this;
        }
        ...
        public Builder infraContainerImage(String infraContainerImage) {
            if (infraContainerImage == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesKubelet", "infraContainerImage");
            }
