...
public final class ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeproxyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeproxyArgs() {}

    private ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeproxyArgs(ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeproxyArgs $) {
    ...
    public static Builder builder(ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeproxyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeproxyArgs defaults) {
            $ = new ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeproxyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeproxyArgs build() {
            return $;
        }
    }
