...
public class AuthConfigPing extends com.pulumi.resources.CustomResource {
     ...
     */
    public AuthConfigPing(java.lang.String name) {
     ...
     */
    public AuthConfigPing(java.lang.String name, AuthConfigPingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AuthConfigPing(java.lang.String name, AuthConfigPingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rancher2:index/authConfigPing:AuthConfigPing", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AuthConfigPing(java.lang.String name, Output<java.lang.String> id, @Nullable AuthConfigPingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rancher2:index/authConfigPing:AuthConfigPing", name, state, makeResourceOptions(options, id), false);
    }

    private static AuthConfigPingArgs makeArgs(AuthConfigPingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AuthConfigPingArgs.Empty : args;
    }
     ...
     */
    public static AuthConfigPing get(java.lang.String name, Output<java.lang.String> id, @Nullable AuthConfigPingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
