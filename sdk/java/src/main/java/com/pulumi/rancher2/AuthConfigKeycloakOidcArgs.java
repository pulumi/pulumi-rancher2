...
public final class AuthConfigKeycloakOidcArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthConfigKeycloakOidcArgs Empty = new AuthConfigKeycloakOidcArgs();
    ...
    private AuthConfigKeycloakOidcArgs() {}

    private AuthConfigKeycloakOidcArgs(AuthConfigKeycloakOidcArgs $) {
    ...
    public static Builder builder(AuthConfigKeycloakOidcArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthConfigKeycloakOidcArgs();
        }

        public Builder(AuthConfigKeycloakOidcArgs defaults) {
            $ = new AuthConfigKeycloakOidcArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param groupSearchEnabled Enable group search.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param groupsField The name of the OIDC claim to use for the user&#39;s group memberships.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param scopes The OIDC scopes to request. Defaults to `openid profile email`.
         * 
         * @return builder
         * 
         */
        ...
        public AuthConfigKeycloakOidcArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("AuthConfigKeycloakOidcArgs", "clientId");
            }
            if ($.clientSecret == null) {
                throw new MissingRequiredPropertyException("AuthConfigKeycloakOidcArgs", "clientSecret");
            }
            if ($.issuer == null) {
                throw new MissingRequiredPropertyException("AuthConfigKeycloakOidcArgs", "issuer");
            }
            if ($.rancherUrl == null) {
                throw new MissingRequiredPropertyException("AuthConfigKeycloakOidcArgs", "rancherUrl");
            }
            return $;
        }
    }
