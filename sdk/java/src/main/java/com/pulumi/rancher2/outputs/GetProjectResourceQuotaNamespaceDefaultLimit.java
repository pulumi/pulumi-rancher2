...
public final class GetProjectResourceQuotaNamespaceDefaultLimit {
    ...
    public static final class Builder {
        ...
        public Builder servicesNodePorts(@Nullable String servicesNodePorts) {
            ...
            return new GetProjectResourceQuotaNamespaceDefaultLimit(configMaps, limitsCpu, limitsMemory, persistentVolumeClaims, pods, replicationControllers, requestsCpu, requestsMemory, requestsStorage, secrets, services, servicesLoadBalancers, servicesNodePorts);
        }
    }
}
