...
public final class ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs Empty = new ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs();
    ...
    private ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs() {}

    private ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs(ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs $) {
    ...
    public static Builder builder(ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs();
        }

        public Builder(ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs defaults) {
            $ = new ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesSchedulerArgs build() {
            return $;
        }
    }
