...
public final class NodePoolNodeTaint {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("NodePoolNodeTaint", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("NodePoolNodeTaint", "value");
            }
            this.value = value;
            return this;
        }
        public NodePoolNodeTaint build() {
            final var _resultValue = new NodePoolNodeTaint();
