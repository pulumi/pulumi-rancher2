...
@CustomType
public final class ClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem {
    /**
    ...
    public static Builder builder(ClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String permissions;
        public Builder() {}
        public Builder(ClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("ClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("ClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem", "path");
            }
            this.path = path;
            return this;
        }
        ...
        public ClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem build() {
            final var _resultValue = new ClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem();
