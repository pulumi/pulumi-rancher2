...
public final class ClusterV2RkeConfigEtcdArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * ETCD snapshot schedule cron (e.g `\&#34;0 *{@literal /}5 * * *\&#34;`) (string)
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param disableSnapshots Disable ETCD snapshots. Default: `false` (bool)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param s3Config Creation option for etcd service (list maxitems:1)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param snapshotRetention ETCD snapshot retention (int)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param snapshotScheduleCron ETCD snapshot schedule cron (e.g `\&#34;0 *{@literal /}5 * * *\&#34;`) (string)
         * 
         * @return builder
         * 
         */
