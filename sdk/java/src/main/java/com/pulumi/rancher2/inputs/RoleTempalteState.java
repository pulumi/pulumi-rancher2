...
public final class RoleTempalteState extends com.pulumi.resources.ResourceArgs {

    public static final RoleTempalteState Empty = new RoleTempalteState();
    ...
    private RoleTempalteState() {}

    private RoleTempalteState(RoleTempalteState $) {
    ...
    public static Builder builder(RoleTempalteState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoleTempalteState();
        }

        public Builder(RoleTempalteState defaults) {
            $ = new RoleTempalteState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param builtin (Computed) Builtin role template (string)
         * 
         * @return builder
         * 
         */
        ...
        public RoleTempalteState build() {
            return $;
        }
    }
