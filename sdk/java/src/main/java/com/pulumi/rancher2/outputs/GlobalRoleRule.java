...
@CustomType
public final class GlobalRoleRule {
    /**
    ...
    public static Builder builder(GlobalRoleRule defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GlobalRoleRule defaults) {
        ...
        public Builder verbs(String... verbs) {
            ...
            return new GlobalRoleRule(apiGroups, nonResourceUrls, resourceNames, resources, verbs);
        }
    }
}
