    ...
    public static final class Builder {
        ...
        public Builder customConfig(String customConfig) {
            if (customConfig == null) {
              throw new MissingRequiredPropertyException("GetClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesKubeApiSecretsEncryptionConfig", "customConfig");
            }
