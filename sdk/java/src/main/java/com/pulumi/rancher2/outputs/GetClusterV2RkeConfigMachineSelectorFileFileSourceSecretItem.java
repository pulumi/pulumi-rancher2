...
@CustomType
public final class GetClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem {
    /**
    ...
    private GetClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem() {}
    /**
     * @return If ture, the file is ignored when determining whether the node should be drained before updating the node plan (default: true).
     * 
     */
    ...
    public static Builder builder(GetClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String permissions;
        public Builder() {}
        public Builder(GetClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("GetClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem", "path");
            }
            this.path = path;
            return this;
        }
        ...
        public GetClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem build() {
            final var _resultValue = new GetClusterV2RkeConfigMachineSelectorFileFileSourceSecretItem();
