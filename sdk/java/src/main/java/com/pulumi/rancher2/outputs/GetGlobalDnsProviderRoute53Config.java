...
public final class GetGlobalDnsProviderRoute53Config {
    ...
    public static final class Builder {
        ...
        public Builder accessKey(String accessKey) {
            if (accessKey == null) {
              throw new MissingRequiredPropertyException("GetGlobalDnsProviderRoute53Config", "accessKey");
            }
        ...
        public Builder secretKey(String secretKey) {
            if (secretKey == null) {
              throw new MissingRequiredPropertyException("GetGlobalDnsProviderRoute53Config", "secretKey");
            }
