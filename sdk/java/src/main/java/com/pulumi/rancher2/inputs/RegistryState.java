...
public final class RegistryState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<RegistryRegistryArgs>> registries;

    /**
     * @return Registries data for registry (list)
     * 
     */
    public Optional<Output<List<RegistryRegistryArgs>>> registries() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder registries(@Nullable Output<List<RegistryRegistryArgs>> registries) {
