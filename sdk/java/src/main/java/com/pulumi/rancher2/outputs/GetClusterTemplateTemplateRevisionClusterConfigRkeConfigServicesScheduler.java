...
public final class GetClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesScheduler {
    ...
    public static final class Builder {
        ...
        public Builder extraArgs(Map<String,Object> extraArgs) {
            if (extraArgs == null) {
              throw new MissingRequiredPropertyException("GetClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesScheduler", "extraArgs");
            }
        ...
        public Builder image(String image) {
            if (image == null) {
              throw new MissingRequiredPropertyException("GetClusterTemplateTemplateRevisionClusterConfigRkeConfigServicesScheduler", "image");
            }
            this.image = image;
            return this;
        }
