...
public final class ClusterV2RkeConfigUpgradeStrategyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param controlPlaneConcurrency How many controlplane nodes should be upgrade at time, 0 is infinite. Percentages are also accepted (string)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param controlPlaneDrainOptions Controlplane nodes drain options (list maxitems:1)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param workerConcurrency How many worker nodes should be upgrade at time. Percentages are also accepted (string)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param workerDrainOptions Worker nodes drain options (list maxitems:1)
         * 
         * @return builder
         * 
         */
