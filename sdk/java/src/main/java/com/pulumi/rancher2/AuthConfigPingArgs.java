    ...
    public static final class Builder {
        ...
        public AuthConfigPingArgs build() {
            if ($.displayNameField == null) {
                throw new MissingRequiredPropertyException("AuthConfigPingArgs", "displayNameField");
            }
            if ($.groupsField == null) {
                throw new MissingRequiredPropertyException("AuthConfigPingArgs", "groupsField");
            }
            if ($.idpMetadataContent == null) {
                throw new MissingRequiredPropertyException("AuthConfigPingArgs", "idpMetadataContent");
            }
            if ($.rancherApiHost == null) {
                throw new MissingRequiredPropertyException("AuthConfigPingArgs", "rancherApiHost");
            }
            if ($.spCert == null) {
                throw new MissingRequiredPropertyException("AuthConfigPingArgs", "spCert");
            }
            if ($.spKey == null) {
                throw new MissingRequiredPropertyException("AuthConfigPingArgs", "spKey");
            }
            if ($.uidField == null) {
                throw new MissingRequiredPropertyException("AuthConfigPingArgs", "uidField");
            }
