...
@CustomType
public final class GetClusterV2RkeConfigMachineSelectorFileFileSourceConfigmapItem {
    /**
    ...
    private GetClusterV2RkeConfigMachineSelectorFileFileSourceConfigmapItem() {}
    /**
     * @return If ture, the file is ignored when determining whether the node should be drained before updating the node plan (default: true).
     * 
     */
    ...
    public static Builder builder(GetClusterV2RkeConfigMachineSelectorFileFileSourceConfigmapItem defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String permissions;
        public Builder() {}
        public Builder(GetClusterV2RkeConfigMachineSelectorFileFileSourceConfigmapItem defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetClusterV2RkeConfigMachineSelectorFileFileSourceConfigmapItem", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("GetClusterV2RkeConfigMachineSelectorFileFileSourceConfigmapItem", "path");
            }
            this.path = path;
            return this;
        }
        ...
        public GetClusterV2RkeConfigMachineSelectorFileFileSourceConfigmapItem build() {
            final var _resultValue = new GetClusterV2RkeConfigMachineSelectorFileFileSourceConfigmapItem();
