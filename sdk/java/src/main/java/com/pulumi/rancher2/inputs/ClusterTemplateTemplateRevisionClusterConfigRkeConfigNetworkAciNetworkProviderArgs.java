...
public final class ClusterTemplateTemplateRevisionClusterConfigRkeConfigNetworkAciNetworkProviderArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterTemplateTemplateRevisionClusterConfigRkeConfigNetworkAciNetworkProviderArgs Empty = new ClusterTemplateTemplateRevisionClusterConfigRkeConfigNetworkAciNetworkProviderArgs();
    ...
    private ClusterTemplateTemplateRevisionClusterConfigRkeConfigNetworkAciNetworkProviderArgs() {}

    private ClusterTemplateTemplateRevisionClusterConfigRkeConfigNetworkAciNetworkProviderArgs(ClusterTemplateTemplateRevisionClusterConfigRkeConfigNetworkAciNetworkProviderArgs $) {
        this.aep = $.aep;
    ...
    public static Builder builder(ClusterTemplateTemplateRevisionClusterConfigRkeConfigNetworkAciNetworkProviderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterTemplateTemplateRevisionClusterConfigRkeConfigNetworkAciNetworkProviderArgs();
        }

        public Builder(ClusterTemplateTemplateRevisionClusterConfigRkeConfigNetworkAciNetworkProviderArgs defaults) {
            $ = new ClusterTemplateTemplateRevisionClusterConfigRkeConfigNetworkAciNetworkProviderArgs(Objects.requireNonNull(defaults));
        }
