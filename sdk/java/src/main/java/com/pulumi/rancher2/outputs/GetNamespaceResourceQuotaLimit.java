...
@CustomType
public final class GetNamespaceResourceQuotaLimit {
    ...
    private GetNamespaceResourceQuotaLimit(
    ...
    public static Builder builder(GetNamespaceResourceQuotaLimit defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetNamespaceResourceQuotaLimit defaults) {
        ...
        public Builder servicesNodePorts(@Nullable String servicesNodePorts) {
            this.servicesNodePorts = servicesNodePorts;
            return this;
        }        public GetNamespaceResourceQuotaLimit build() {
            return new GetNamespaceResourceQuotaLimit(configMaps, limitsCpu, limitsMemory, persistentVolumeClaims, pods, replicationControllers, requestsCpu, requestsMemory, requestsStorage, secrets, services, servicesLoadBalancers, servicesNodePorts);
        }
    }
}
