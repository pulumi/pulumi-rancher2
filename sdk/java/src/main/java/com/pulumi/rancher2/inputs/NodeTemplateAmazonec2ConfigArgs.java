...
public final class NodeTemplateAmazonec2ConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public NodeTemplateAmazonec2ConfigArgs build() {
            if ($.ami == null) {
                throw new MissingRequiredPropertyException("NodeTemplateAmazonec2ConfigArgs", "ami");
            }
            if ($.region == null) {
                throw new MissingRequiredPropertyException("NodeTemplateAmazonec2ConfigArgs", "region");
            }
            if ($.securityGroups == null) {
                throw new MissingRequiredPropertyException("NodeTemplateAmazonec2ConfigArgs", "securityGroups");
            }
            if ($.subnetId == null) {
                throw new MissingRequiredPropertyException("NodeTemplateAmazonec2ConfigArgs", "subnetId");
            }
            if ($.vpcId == null) {
                throw new MissingRequiredPropertyException("NodeTemplateAmazonec2ConfigArgs", "vpcId");
            }
            if ($.zone == null) {
                throw new MissingRequiredPropertyException("NodeTemplateAmazonec2ConfigArgs", "zone");
            }
            return $;
        }
    }
