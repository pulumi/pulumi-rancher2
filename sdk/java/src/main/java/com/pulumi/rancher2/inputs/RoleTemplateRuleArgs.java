...
public final class RoleTemplateRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final RoleTemplateRuleArgs Empty = new RoleTemplateRuleArgs();
    ...
    private RoleTemplateRuleArgs() {}

    private RoleTemplateRuleArgs(RoleTemplateRuleArgs $) {
    ...
    public static Builder builder(RoleTemplateRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoleTemplateRuleArgs();
        }

        public Builder(RoleTemplateRuleArgs defaults) {
            $ = new RoleTemplateRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RoleTemplateRuleArgs build() {
            return $;
        }
    }
