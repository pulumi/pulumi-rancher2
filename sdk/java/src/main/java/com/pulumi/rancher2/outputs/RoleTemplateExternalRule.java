...
@CustomType
public final class RoleTemplateExternalRule {
    /**
    ...
    public static Builder builder(RoleTemplateExternalRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> verbs;
        public Builder() {}
        public Builder(RoleTemplateExternalRule defaults) {
        ...
        public RoleTemplateExternalRule build() {
            final var _resultValue = new RoleTemplateExternalRule();
