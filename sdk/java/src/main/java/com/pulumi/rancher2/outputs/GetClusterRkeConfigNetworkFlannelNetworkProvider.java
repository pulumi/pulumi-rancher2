...
public final class GetClusterRkeConfigNetworkFlannelNetworkProvider {
    ...
    public static final class Builder {
        ...
        public Builder iface(String iface) {
            if (iface == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigNetworkFlannelNetworkProvider", "iface");
            }
            this.iface = iface;
            return this;
        }
        public GetClusterRkeConfigNetworkFlannelNetworkProvider build() {
            final var _resultValue = new GetClusterRkeConfigNetworkFlannelNetworkProvider();
