...
public final class GetClusterRkeConfigServicesKubeController {
    ...
    public static final class Builder {
        ...
        public Builder clusterCidr(String clusterCidr) {
            if (clusterCidr == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesKubeController", "clusterCidr");
            }
        ...
        public Builder extraArgs(Map<String,Object> extraArgs) {
            if (extraArgs == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesKubeController", "extraArgs");
            }
        ...
        public Builder image(String image) {
            if (image == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesKubeController", "image");
            }
            this.image = image;
            return this;
        }
        ...
        public Builder serviceClusterIpRange(String serviceClusterIpRange) {
            if (serviceClusterIpRange == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigServicesKubeController", "serviceClusterIpRange");
            }
            this.serviceClusterIpRange = serviceClusterIpRange;
            return this;
        }
        public GetClusterRkeConfigServicesKubeController build() {
            final var _resultValue = new GetClusterRkeConfigServicesKubeController();
