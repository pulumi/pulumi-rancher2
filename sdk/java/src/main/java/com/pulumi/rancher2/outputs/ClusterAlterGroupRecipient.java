...
@CustomType
public final class ClusterAlterGroupRecipient {
    /**
    ...
    public static final class Builder {
        ...
        public Builder notifierId(String notifierId) {
            if (notifierId == null) {
              throw new MissingRequiredPropertyException("ClusterAlterGroupRecipient", "notifierId");
            }
        ...
        public ClusterAlterGroupRecipient build() {
            final var _resultValue = new ClusterAlterGroupRecipient();
