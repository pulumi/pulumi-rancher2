...
public class Feature extends com.pulumi.resources.CustomResource {
     ...
     */
    public Feature(java.lang.String name, @Nullable FeatureArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Feature(java.lang.String name, @Nullable FeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rancher2:index/feature:Feature", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Feature(java.lang.String name, Output<java.lang.String> id, @Nullable FeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rancher2:index/feature:Feature", name, state, makeResourceOptions(options, id), false);
    }

    private static FeatureArgs makeArgs(@Nullable FeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
