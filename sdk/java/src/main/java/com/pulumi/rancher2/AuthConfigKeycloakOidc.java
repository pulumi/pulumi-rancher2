...
import com.pulumi.rancher2.AuthConfigKeycloakOidcArgs;
import com.pulumi.rancher2.Utilities;
import com.pulumi.rancher2.inputs.AuthConfigKeycloakOidcState;
...
@ResourceType(type="rancher2:index/authConfigKeycloakOidc:AuthConfigKeycloakOidc")
public class AuthConfigKeycloakOidc extends com.pulumi.resources.CustomResource {
     ...
     */
    public AuthConfigKeycloakOidc(java.lang.String name) {
        this(name, AuthConfigKeycloakOidcArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AuthConfigKeycloakOidc(java.lang.String name, AuthConfigKeycloakOidcArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AuthConfigKeycloakOidc(java.lang.String name, AuthConfigKeycloakOidcArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rancher2:index/authConfigKeycloakOidc:AuthConfigKeycloakOidc", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AuthConfigKeycloakOidc(java.lang.String name, Output<java.lang.String> id, @Nullable AuthConfigKeycloakOidcState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("rancher2:index/authConfigKeycloakOidc:AuthConfigKeycloakOidc", name, state, makeResourceOptions(options, id), false);
    }

    private static AuthConfigKeycloakOidcArgs makeArgs(AuthConfigKeycloakOidcArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AuthConfigKeycloakOidcArgs.Empty : args;
    }
     ...
     */
    public static AuthConfigKeycloakOidc get(java.lang.String name, Output<java.lang.String> id, @Nullable AuthConfigKeycloakOidcState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new AuthConfigKeycloakOidc(name, id, state, options);
    }
}
