...
public final class ProjectResourceQuotaProjectLimit {
    ...
    public static final class Builder {
        ...
        public Builder servicesNodePorts(@Nullable String servicesNodePorts) {
            ...
            return new ProjectResourceQuotaProjectLimit(configMaps, limitsCpu, limitsMemory, persistentVolumeClaims, pods, replicationControllers, requestsCpu, requestsMemory, requestsStorage, secrets, services, servicesLoadBalancers, servicesNodePorts);
        }
    }
}
