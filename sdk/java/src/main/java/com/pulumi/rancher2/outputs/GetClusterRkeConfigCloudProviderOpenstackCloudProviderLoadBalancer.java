    ...
    public static final class Builder {
        ...
        public Builder createMonitor(Boolean createMonitor) {
            if (createMonitor == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigCloudProviderOpenstackCloudProviderLoadBalancer", "createMonitor");
            }
        ...
        public Builder floatingNetworkId(String floatingNetworkId) {
            if (floatingNetworkId == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigCloudProviderOpenstackCloudProviderLoadBalancer", "floatingNetworkId");
            }
        ...
        public Builder lbMethod(String lbMethod) {
            if (lbMethod == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigCloudProviderOpenstackCloudProviderLoadBalancer", "lbMethod");
            }
        ...
        public Builder lbProvider(String lbProvider) {
            if (lbProvider == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigCloudProviderOpenstackCloudProviderLoadBalancer", "lbProvider");
            }
        ...
        public Builder lbVersion(String lbVersion) {
            if (lbVersion == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigCloudProviderOpenstackCloudProviderLoadBalancer", "lbVersion");
            }
        ...
        public Builder manageSecurityGroups(Boolean manageSecurityGroups) {
            if (manageSecurityGroups == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigCloudProviderOpenstackCloudProviderLoadBalancer", "manageSecurityGroups");
            }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigCloudProviderOpenstackCloudProviderLoadBalancer", "subnetId");
            }
        ...
        public Builder useOctavia(Boolean useOctavia) {
            if (useOctavia == null) {
              throw new MissingRequiredPropertyException("GetClusterRkeConfigCloudProviderOpenstackCloudProviderLoadBalancer", "useOctavia");
            }
