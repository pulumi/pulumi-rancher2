...
public final class ClusterRkeConfigMonitoringUpdateStrategyRollingUpdateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterRkeConfigMonitoringUpdateStrategyRollingUpdateArgs() {}

    private ClusterRkeConfigMonitoringUpdateStrategyRollingUpdateArgs(ClusterRkeConfigMonitoringUpdateStrategyRollingUpdateArgs $) {
    ...
    public static Builder builder(ClusterRkeConfigMonitoringUpdateStrategyRollingUpdateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterRkeConfigMonitoringUpdateStrategyRollingUpdateArgs();
        }

        public Builder(ClusterRkeConfigMonitoringUpdateStrategyRollingUpdateArgs defaults) {
            $ = new ClusterRkeConfigMonitoringUpdateStrategyRollingUpdateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterRkeConfigMonitoringUpdateStrategyRollingUpdateArgs build() {
            return $;
        }
    }
