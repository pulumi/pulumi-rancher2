...
public final class GetClusterV2RkeConfigMachinePoolTaint {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetClusterV2RkeConfigMachinePoolTaint", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetClusterV2RkeConfigMachinePoolTaint", "value");
            }
            this.value = value;
            return this;
        }
